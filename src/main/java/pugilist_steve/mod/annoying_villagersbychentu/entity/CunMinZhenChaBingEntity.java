...
public class CunMinZhenChaBingEntity extends PathfinderMob {
    public CunMinZhenChaBingEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(AnnoyingVillagersbychentuModEntities.CUN_MIN_ZHEN_CHA_BING.get(), world);
    }

    public CunMinZhenChaBingEntity(EntityType<CunMinZhenChaBingEntity> type, Level world) {
        super(type, world);
        this.maxUpStep = 2.0f;
        this.xpReward = 8;
        this.setNoAi(false);
        ...
        this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(AnnoyingVillagersbychentuModItems.CLASSICGOLDENA_CHESTPLATE.get()));
        this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(AnnoyingVillagersbychentuModItems.CLASSICGOLDENA_LEGGINGS.get()));
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(AnnoyingVillagersbychentuModItems.CLASSICGOLDENA_BOOTS.get()));
    }

    @SubscribeEvent
    public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
        event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(AnnoyingVillagersbychentuModEntities.CUN_MIN_ZHEN_CHA_BING.get(), 13, 1, 4));
    }

    public static void init() {
        SpawnPlacements.register((EntityType) AnnoyingVillagersbychentuModEntities.CUN_MIN_ZHEN_CHA_BING.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        return builder.add(Attributes.MOVEMENT_SPEED, 0.25d).add(Attributes.MAX_HEALTH, 20.0d).add(Attributes.ARMOR, 5.0d).add(Attributes.ATTACK_DAMAGE, 0.0d).add(Attributes.FOLLOW_RANGE, 128.0d);
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(16, new NearestAttackableTargetGoal(this, MrMudgeMonkeyEntity.class, true, true));
        ...
        this.goalSelector.addGoal(19, new MeleeAttackGoal(this, 1.5d, false) { // from class: pugilist_steve.mod.annoying_villagersbychentu.entity.CunMinZhenChaBingEntity.1
            @Override
            protected double getAttackReachSqr(LivingEntity entity) {
                return (this.mob.getBbWidth() * this.mob.getBbWidth()) + entity.getBbWidth();
            }
        });
        this.targetSelector.addGoal(20, new NearestAttackableTargetGoal(this, Steve2Entity.class, true, false));
    ...
    public boolean hurt(DamageSource source, float amount) {
        CunMinZhenChaBingDangShiTiShouShangShiProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
        ...
        CunMinZhenChaBingShiTiChuShiShengChengShiProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
        return retval;
    }
