...
public class GravedeadEntity extends Monster {
    public GravedeadEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(AnnoyingVillagersbychentuModEntities.GRAVEDEAD.get(), world);
    }

    public GravedeadEntity(EntityType<GravedeadEntity> type, Level world) {
        super(type, world);
        this.maxUpStep = 0.6f;
        this.xpReward = 0;
        this.setNoAi(false);
