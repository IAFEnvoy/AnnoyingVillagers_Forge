...
import pugilist_steve.mod.annoying_villagersbychentu.procedures.MrMudgeMonkeyShiTiChuShiShengChengShiProcedure;

import javax.annotation.Nullable;


public class MrMudgeMonkeyEntity extends PathfinderMob {
    public MrMudgeMonkeyEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(AnnoyingVillagersbychentuModEntities.MR_MUDGE_MONKEY.get(), world);
    }

    public MrMudgeMonkeyEntity(EntityType<MrMudgeMonkeyEntity> type, Level world) {
        super(type, world);
        this.maxUpStep = 0.6f;
        this.xpReward = 0;
        this.setNoAi(false);
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        return builder.add(Attributes.MOVEMENT_SPEED, 0.26d).add(Attributes.MAX_HEALTH, 1000.0d).add(Attributes.ARMOR, 10.0d).add(Attributes.ATTACK_DAMAGE, 2.0d).add(Attributes.FOLLOW_RANGE, 16.0d);
    }
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2d, false) { // from class: pugilist_steve.mod.annoying_villagersbychentu.entity.MrMudgeMonkeyEntity.1
            @Override
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
        ...
        MrMudgeMonkeyShiTiChuShiShengChengShiProcedure.execute(this);
        return retval;
    }
