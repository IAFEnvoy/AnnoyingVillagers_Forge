...
public class MrcolderdeadEntity extends Monster {
    public MrcolderdeadEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(AnnoyingVillagersbychentuModEntities.MRCOLDERDEAD.get(), world);
    }

    public MrcolderdeadEntity(EntityType<MrcolderdeadEntity> type, Level world) {
        super(type, world);
        this.maxUpStep = 0.6f;
        this.xpReward = 0;
        this.setNoAi(false);
        this.setCustomName(new TextComponent("Mr_colder"));
