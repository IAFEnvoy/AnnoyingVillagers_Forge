...
public class Null2Entity extends Monster {
    public Null2Entity(PlayMessages.SpawnEntity packet, Level world) {
        this(AnnoyingVillagersbychentuModEntities.NULL_2.get(), world);
    }

    public Null2Entity(EntityType<Null2Entity> type, Level world) {
        super(type, world);
        this.maxUpStep = 60.0f;
        this.xpReward = 80;
        this.setNoAi(false);
        this.setPersistenceRequired();
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(AnnoyingVillagersbychentuModItems.DIAMOND_A.get()));
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(23, new MeleeAttackGoal(this, 2.0d, false) { // from class: pugilist_steve.mod.annoying_villagersbychentu.entity.Null2Entity.1
            @Override
        ...
        this.goalSelector.addGoal(25, new RandomStrollGoal(this, 0.4d, 20) { // from class: pugilist_steve.mod.annoying_villagersbychentu.entity.Null2Entity.2
            @Override
            protected Vec3 getPosition() {
                Random random = Null2Entity.this.getRandom();
                double dir_x = Null2Entity.this.getX() + (((random.nextFloat() * 2.0f) - 1.0f) * 16.0f);
                double dir_y = Null2Entity.this.getY() + (((random.nextFloat() * 2.0f) - 1.0f) * 16.0f);
                double dir_z = Null2Entity.this.getZ() + (((random.nextFloat() * 2.0f) - 1.0f) * 16.0f);
