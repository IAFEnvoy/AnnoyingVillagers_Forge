...
public class Null6Entity extends Monster {
    public Null6Entity(PlayMessages.SpawnEntity packet, Level world) {
        this(AnnoyingVillagersbychentuModEntities.NULL_6.get(), world);
    }

    public Null6Entity(EntityType<Null6Entity> type, Level world) {
        super(type, world);
        this.maxUpStep = 60.0f;
        this.xpReward = 80;
        this.setNoAi(false);
        this.setPersistenceRequired();
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(AnnoyingVillagersbychentuModItems.DIAMOND_C.get()));
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(23, new MeleeAttackGoal(this, 2.0d, false) { // from class: pugilist_steve.mod.annoying_villagersbychentu.entity.Null6Entity.1
            @Override
        ...
        this.goalSelector.addGoal(25, new RandomStrollGoal(this, 0.6d, 20) { // from class: pugilist_steve.mod.annoying_villagersbychentu.entity.Null6Entity.2
            @Override
            protected Vec3 getPosition() {
                Random random = Null6Entity.this.getRandom();
                double dir_x = Null6Entity.this.getX() + (((random.nextFloat() * 2.0f) - 1.0f) * 16.0f);
                double dir_y = Null6Entity.this.getY() + (((random.nextFloat() * 2.0f) - 1.0f) * 16.0f);
                double dir_z = Null6Entity.this.getZ() + (((random.nextFloat() * 2.0f) - 1.0f) * 16.0f);
