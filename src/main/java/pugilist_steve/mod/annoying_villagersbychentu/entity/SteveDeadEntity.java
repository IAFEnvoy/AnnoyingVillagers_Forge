...
public class SteveDeadEntity extends Monster {
    public SteveDeadEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(AnnoyingVillagersbychentuModEntities.STEVE_DEAD.get(), world);
    }

    public SteveDeadEntity(EntityType<SteveDeadEntity> type, Level world) {
        super(type, world);
        this.maxUpStep = 0.6f;
        this.xpReward = 0;
        this.setNoAi(false);
