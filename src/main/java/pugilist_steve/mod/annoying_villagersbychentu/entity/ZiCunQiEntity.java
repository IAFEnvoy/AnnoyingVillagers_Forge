...
public class ZiCunQiEntity extends PathfinderMob {
    public ZiCunQiEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(AnnoyingVillagersbychentuModEntities.ZI_CUN_QI.get(), world);
    }

    public ZiCunQiEntity(EntityType<ZiCunQiEntity> type, Level world) {
        super(type, world);
        this.maxUpStep = 2.0f;
        this.xpReward = 0;
        this.setNoAi(false);
        ...
        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(AnnoyingVillagersbychentuModItems.ZICUNQITOUKUI.get()));
        this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(AnnoyingVillagersbychentuModItems.ZI_CUN_QI_KUI_JIA_CHESTPLATE.get()));
        this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(AnnoyingVillagersbychentuModItems.ZI_CUN_QI_KUI_JIA_LEGGINGS.get()));
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(AnnoyingVillagersbychentuModItems.ZI_CUN_QI_KUI_JIA_BOOTS.get()));
    }

    @SubscribeEvent
    public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
        event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(AnnoyingVillagersbychentuModEntities.ZI_CUN_QI.get(), 3, 1, 1));
    }

    public static void init() {
        SpawnPlacements.register((EntityType) AnnoyingVillagersbychentuModEntities.ZI_CUN_QI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        return builder.add(Attributes.MOVEMENT_SPEED, 0.25d).add(Attributes.MAX_HEALTH, 20.0d).add(Attributes.ARMOR, 8.0d).add(Attributes.ATTACK_DAMAGE, 0.0d).add(Attributes.FOLLOW_RANGE, 128.0d);
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(15, new NearestAttackableTargetGoal(this, MrcolderEntity.class, true, false));
        this.targetSelector.addGoal(16, new NearestAttackableTargetGoal(this, MrMudgeMonkeyEntity.class, true, false));
        this.targetSelector.addGoal(17, new NearestAttackableTargetGoal(this, LingZhiEntity.class, true, false));
        this.targetSelector.addGoal(18, new NearestAttackableTargetGoal(this, ZaiEZhiWangEntity.class, true, false));
        this.goalSelector.addGoal(19, new MeleeAttackGoal(this, 1.5d, false) { // from class: pugilist_steve.mod.annoying_villagersbychentu.entity.ZiCunQiEntity.1
            @Override
        ...
        this.targetSelector.addGoal(25, new NearestAttackableTargetGoal(this, CunZhenFuLuEntity.class, true, true));
        this.targetSelector.addGoal(26, new NearestAttackableTargetGoal(this, LanCunQiFuLuEntity.class, true, true));
        this.targetSelector.addGoal(27, new NearestAttackableTargetGoal(this, LvcunqifuluEntity.class, true, true));
        this.targetSelector.addGoal(28, new NearestAttackableTargetGoal(this, HongCunQiFuLuEntity.class, true, true));
        this.targetSelector.addGoal(29, new NearestAttackableTargetGoal(this, ZiCunQiFuLuEntity.class, true, true));
    }
    ...
    public void die(DamageSource source) {
        super.die(source);
        ZiCunQiDangShiTiBeiShaSiShiProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
    }
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        ZiCunQiDangYouJiShiTiShiProcedure.execute(world, x, y, z, this);
        return retval;
    }
