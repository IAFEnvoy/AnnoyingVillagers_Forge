...
public class Herobrine3Entity extends Monster {
    public Herobrine3Entity(PlayMessages.SpawnEntity packet, Level world) {
        this(AnnoyingVillagersbychentuModEntities.HEROBRINE_3.get(), world);
    }
    ...
    public Herobrine3Entity(EntityType<Herobrine3Entity> type, Level world) {
        ...
        this.xpReward = 50;
        this.setNoAi(false);
        this.setCustomName(new TextComponent("§5herobrine§f3号"));
    ...
    public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
        event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(AnnoyingVillagersbychentuModEntities.HEROBRINE_3.get(), 2, 1, 1));
    }

    public static void init() {
        SpawnPlacements.register((EntityType) AnnoyingVillagersbychentuModEntities.HEROBRINE_3.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            return world.getBlockState(pos.below()).getMaterial() == Material.GRASS && world.getRawBrightness(pos, 0) > 8;
        });
        DungeonHooks.addDungeonMob(AnnoyingVillagersbychentuModEntities.HEROBRINE_3.get(), 180);
    }

    public static AttributeSupplier.Builder createAttributes() {
        AttributeSupplier.Builder builder = Mob.createMobAttributes();
        return builder.add(Attributes.MOVEMENT_SPEED, 0.3d).add(Attributes.MAX_HEALTH, 40.0d).add(Attributes.ARMOR, 25.0d).add(Attributes.ATTACK_DAMAGE, 10.0d).add(Attributes.FOLLOW_RANGE, 128.0d);
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, Zaiezhiwang2Entity.class, true, false));
        this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, MrcolderEntity.class, true, false));
        this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, Grave2Entity.class, true, false));
        this.targetSelector.addGoal(12, new NearestAttackableTargetGoal(this, SteveEntity.class, true, false));
        this.targetSelector.addGoal(13, new NearestAttackableTargetGoal(this, Mrcolder2Entity.class, true, false));
        this.targetSelector.addGoal(14, new NearestAttackableTargetGoal(this, EnchanterEntity.class, true, false));
        this.targetSelector.addGoal(15, new NearestAttackableTargetGoal(this, KeLiSiEntity.class, true, false));
        this.targetSelector.addGoal(16, new NearestAttackableTargetGoal(this, FennudeshidifuEntity.class, true, false));
        ...
        this.targetSelector.addGoal(19, new NearestAttackableTargetGoal(this, JianbingguoziEntity.class, true, false));
        this.targetSelector.addGoal(20, new NearestAttackableTargetGoal(this, BlueDemonEntity.class, true, false));
        this.targetSelector.addGoal(21, new NearestAttackableTargetGoal(this, ShiTi303Entity.class, true, false));
        this.targetSelector.addGoal(22, new NearestAttackableTargetGoal(this, AlexEntity.class, true, false));
        this.targetSelector.addGoal(23, new NearestAttackableTargetGoal(this, ZaiEZhiWangEntity.class, true, false));
        this.targetSelector.addGoal(24, new NearestAttackableTargetGoal(this, NishidierjieEntity.class, true, false));
        this.goalSelector.addGoal(25, new MeleeAttackGoal(this, 1.5d, false) { // from class: pugilist_steve.mod.annoying_villagersbychentu.entity.Herobrine3Entity.1
            @Override
    ...
    public void die(DamageSource source) {
        super.die(source);
        Herobrine3DangShiTiSiWangShi2Procedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
    }
    ...
    public void baseTick() {
        super.baseTick();
        Herobrine3DangShiTiGengXiKeShiProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
    }

    @Override
    public void playerTouch(Player sourceentity) {
        super.playerTouch(sourceentity);
        Herobrine3DangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
    }
}
