...
public class HeisezhenzhuEntity extends AbstractArrow implements ItemSupplier {
    public HeisezhenzhuEntity(PlayMessages.SpawnEntity packet, Level world) {
        super(AnnoyingVillagersbychentuModEntities.HEISEZHENZHU.get(), world);
    }

    public HeisezhenzhuEntity(EntityType<? extends HeisezhenzhuEntity> type, Level world) {
        super(type, world);
    }

    public HeisezhenzhuEntity(EntityType<? extends HeisezhenzhuEntity> type, double x, double y, double z, Level world) {
        super(type, x, y, z, world);
    }

    public HeisezhenzhuEntity(EntityType<? extends HeisezhenzhuEntity> type, LivingEntity entity, Level world) {
        super(type, entity, world);
    }

    public static HeisezhenzhuEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
        HeisezhenzhuEntity entityarrow = new HeisezhenzhuEntity(AnnoyingVillagersbychentuModEntities.HEISEZHENZHU.get(), entity, world);
    ...
    public static HeisezhenzhuEntity shoot(LivingEntity entity, LivingEntity target) {
        HeisezhenzhuEntity entityarrow = new HeisezhenzhuEntity(AnnoyingVillagersbychentuModEntities.HEISEZHENZHU.get(), entity, entity.level);
    ...
    public ItemStack getItem() {
        return new ItemStack(AnnoyingVillagersbychentuModItems.HEISEZHENZHU.get());
    }
