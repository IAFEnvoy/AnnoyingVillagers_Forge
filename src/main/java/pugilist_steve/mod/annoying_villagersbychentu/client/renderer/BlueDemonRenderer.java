...
public class BlueDemonRenderer extends HumanoidMobRenderer<BlueDemonEntity, HumanoidModel<BlueDemonEntity>> {
    public BlueDemonRenderer(EntityRendererProvider.Context context) {
        super(context, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
        this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR))));
        this.addLayer(new EyesLayer<BlueDemonEntity, HumanoidModel<BlueDemonEntity>>(this) { // from class: pugilist_steve.mod.annoying_villagersbychentu.client.renderer.BlueDemonRenderer.1
            @Override
    ...
    @Override
    public ResourceLocation getTextureLocation(BlueDemonEntity entity) {
