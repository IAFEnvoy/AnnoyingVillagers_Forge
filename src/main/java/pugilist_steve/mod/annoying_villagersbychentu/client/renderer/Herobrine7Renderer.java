...
import pugilist_steve.mod.annoying_villagersbychentu.entity.Herobrine7Entity;
...
public class Herobrine7Renderer extends HumanoidMobRenderer<Herobrine7Entity, HumanoidModel<Herobrine7Entity>> {
    public Herobrine7Renderer(EntityRendererProvider.Context context) {
        ...
        this.addLayer(new EyesLayer<Herobrine7Entity, HumanoidModel<Herobrine7Entity>>(this) { // from class: pugilist_steve.mod.annoying_villagersbychentu.client.renderer.Herobrine7Renderer.1
            @Override
