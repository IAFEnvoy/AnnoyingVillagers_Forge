...
import pugilist_steve.mod.annoying_villagersbychentu.entity.Grave2Entity;


public class Grave2Renderer extends HumanoidMobRenderer<Grave2Entity, HumanoidModel<Grave2Entity>> {
