...
import pugilist_steve.mod.annoying_villagersbychentu.entity.AlexEntity;
...
public class AlexRenderer extends HumanoidMobRenderer<AlexEntity, HumanoidModel<AlexEntity>> {
    ...
    public ResourceLocation getTextureLocation(AlexEntity entity) {
        return new ResourceLocation("annoying_villagersbychentu:textures/entities/alex.png");
    }
}
