...
/* renamed from: pugilist_steve.mod.annoying_villagersbychentu.client.model.Model蓝村骑俘虏  reason: invalid class name and case insensitive filesystem */
/* loaded from: AV.jar:pugilist_steve/mod/annoying_villagersbychentu/client/model/Model蓝村骑俘虏.class */
public class C1393Model<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AnnoyingVillagersbychentuMod.MODID, "model_lan_cun_qi_fu_lu"), "main");
    ...
    public C1393Model(ModelPart root) {
