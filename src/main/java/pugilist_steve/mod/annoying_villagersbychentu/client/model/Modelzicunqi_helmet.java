...
public class Modelzicunqi_helmet<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AnnoyingVillagersbychentuMod.MODID, "modelzicunqi_helmet"), "main");
    public final ModelPart Head;

    public Modelzicunqi_helmet(ModelPart root) {
