...
public class Modellancunqi_helmet<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AnnoyingVillagersbychentuMod.MODID, "modellancunqi_helmet"), "main");
    public final ModelPart Head;

    public Modellancunqi_helmet(ModelPart root) {
