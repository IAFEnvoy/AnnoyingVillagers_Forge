...
public class Modelhongcunqi_helmet<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AnnoyingVillagersbychentuMod.MODID, "modelhongcunqi_helmet"), "main");
    public final ModelPart Head;

    public Modelhongcunqi_helmet(ModelPart root) {
