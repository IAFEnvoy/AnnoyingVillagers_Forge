...
public abstract class LanCunQiarmorItem extends ArmorItem {
    public LanCunQiarmorItem(EquipmentSlot slot, Properties properties) {
        super(new ArmorMaterial() { // from class: pugilist_steve.mod.annoying_villagersbychentu.item.LanCunQiarmorItem.1
            @Override
            ...
            public int getDefenseForSlot(EquipmentSlot slot2) {
                return new int[]{4, 6, 8, 4}[slot2.getIndex()];
            }
    ...
    public static class Helmet extends LanCunQiarmorItem {
        ...
        public void initializeClient(Consumer<IItemRenderProperties> consumer) {
            consumer.accept(new IItemRenderProperties() { // from class: pugilist_steve.mod.annoying_villagersbychentu.item.LanCunQiarmorItem.Helmet.1
                @Override
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "annoying_villagersbychentu:textures/entities/blue.png";
        }
    }
    ...
    public static class Chestplate extends LanCunQiarmorItem {
        ...
        @Override
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "annoying_villagersbychentu:textures/models/armor/cun_min_qi_shi_lan_se_xiong_jia___layer_1.png";
        }
    }
    ...
    public static class Leggings extends LanCunQiarmorItem {
        ...
        @Override
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "annoying_villagersbychentu:textures/models/armor/cun_min_qi_shi_lan_se_xiong_jia___layer_2.png";
        }
    }
