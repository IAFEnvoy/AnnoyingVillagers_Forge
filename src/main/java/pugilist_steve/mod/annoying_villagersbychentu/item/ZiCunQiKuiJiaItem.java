...
public abstract class ZiCunQiKuiJiaItem extends ArmorItem {
    public ZiCunQiKuiJiaItem(EquipmentSlot slot, Properties properties) {
        super(new ArmorMaterial() { // from class: pugilist_steve.mod.annoying_villagersbychentu.item.ZiCunQiKuiJiaItem.1
            @Override
    ...
    public static class Helmet extends ZiCunQiKuiJiaItem {
        ...
        public void initializeClient(Consumer<IItemRenderProperties> consumer) {
            consumer.accept(new IItemRenderProperties() { // from class: pugilist_steve.mod.annoying_villagersbychentu.item.ZiCunQiKuiJiaItem.Helmet.1
                @Override
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "annoying_villagersbychentu:textures/entities/purple.png";
        }
    }
    ...
    public static class Chestplate extends ZiCunQiKuiJiaItem {
        ...
        @Override
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "annoying_villagersbychentu:textures/models/armor/cun_min_qi_shi_zi_se_xiong_jia___layer_1.png";
        }
    }
    ...
    public static class Leggings extends ZiCunQiKuiJiaItem {
        ...
        @Override
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "annoying_villagersbychentu:textures/models/armor/cun_min_qi_shi_zi_se_xiong_jia___layer_2.png";
        }
    }
