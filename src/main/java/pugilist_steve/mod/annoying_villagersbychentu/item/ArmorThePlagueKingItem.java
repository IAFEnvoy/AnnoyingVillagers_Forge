...
import pugilist_steve.mod.annoying_villagersbychentu.procedures.ArmorThePlagueKingXiongJiaShiJianMeiYouXiKeProcedure;
...
public abstract class ArmorThePlagueKingItem extends ArmorItem {
    public ArmorThePlagueKingItem(EquipmentSlot slot, Properties properties) {
        super(new ArmorMaterial() { // from class: pugilist_steve.mod.annoying_villagersbychentu.item.ArmorThePlagueKingItem.1
            @Override
            public int getDurabilityForSlot(EquipmentSlot slot2) {
                return new int[]{13, 15, 16, 11}[slot2.getIndex()] * 80;
            }

            @Override
            public int getDefenseForSlot(EquipmentSlot slot2) {
                return new int[]{0, 0, 20, 16}[slot2.getIndex()];
            }
    ...
    public static class Chestplate extends ArmorThePlagueKingItem {
        public Chestplate() {
        ...
        public void initializeClient(Consumer<IItemRenderProperties> consumer) {
            consumer.accept(new IItemRenderProperties() { // from class: pugilist_steve.mod.annoying_villagersbychentu.item.ArmorThePlagueKingItem.Chestplate.1
                @Override
                @OnlyIn(Dist.CLIENT)
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "annoying_villagersbychentu:textures/entities/armor_helmet_layer_2.png";
        }

        @Override
        public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
            ArmorThePlagueKingXiongJiaShiJianMeiYouXiKeProcedure.execute(entity);
        }
    }
}
