...
public class GedangMobEffect extends MobEffect {
    ...
    public String getDescriptionId() {
        return "effect.annoying_villagersbychentu.gedang";
    }
    ...
    public void initializeClient(Consumer<EffectRenderer> consumer) {
        consumer.accept(new EffectRenderer() { // from class: pugilist_steve.mod.annoying_villagersbychentu.potion.GedangMobEffect.1
            @Override
