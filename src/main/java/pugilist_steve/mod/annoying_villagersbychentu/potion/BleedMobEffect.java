...
public class BleedMobEffect extends MobEffect {
    ...
    public String getDescriptionId() {
        return "effect.annoying_villagersbychentu.bleed";
    }
    ...
    public void initializeClient(Consumer<EffectRenderer> consumer) {
        consumer.accept(new EffectRenderer() { // from class: pugilist_steve.mod.annoying_villagersbychentu.potion.BleedMobEffect.1
            @Override
