...
public class DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure {
    /* JADX WARN: Type inference failed for: r0v38, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$4] */
    /* JADX WARN: Type inference failed for: r0v39, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$5] */
    /* JADX WARN: Type inference failed for: r0v51, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$3] */
    /* JADX WARN: Type inference failed for: r0v68, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$2] */
        ...
        for (Entity entity2 : _entfound) {
            ...
            if (entity2 == livingEntity) {
                if (Math.random() <= 0.01d) {
                    ...
                    new C04401(entity).start(world, 1);
                }
                if (Math.random() <= 0.1d) {
                    ...
                    if (!projectileLevel.isClientSide()) {
                        Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.2
                        ...
                        }.getArrow(projectileLevel, entity, 13.0f, 3, (byte) 2);
                    ...
                    if (!projectileLevel2.isClientSide()) {
                        Projectile _entityToSpawn2 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.3
                            public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
                                AbstractArrow entityToSpawn = new YinshenEntity(AnnoyingVillagersbychentuModEntities.YINSHEN.get(), level);
                                entityToSpawn.setOwner(shooter);
                                entityToSpawn.setBaseDamage(damage);
                        ...
                        }.getArrow(projectileLevel2, entity, 12.0f, 2, (byte) 2);
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.4
                        private int ticks = 0;
                        ...
                        /* JADX WARN: Type inference failed for: r0v47, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$4$2] */
                        /* JADX WARN: Type inference failed for: r0v59, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$4$1] */
                        private void run() {
                            Entity _shootFrom = entity;
                            Level projectileLevel3 = _shootFrom.level;
                            if (!projectileLevel3.isClientSide()) {
                                Projectile _entityToSpawn3 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.4.1
                                    public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
                                        AbstractArrow entityToSpawn = new YinshenEntity(AnnoyingVillagersbychentuModEntities.YINSHEN.get(), level);
                                        entityToSpawn.setOwner(shooter);
                                        entityToSpawn.setBaseDamage(damage);
                                ...
                                }.getArrow(projectileLevel3, entity, 15.0f, 4, (byte) 2);
                            ...
                            if (!projectileLevel4.isClientSide()) {
                                Projectile _entityToSpawn4 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.4.2
                                ...
                                }.getArrow(projectileLevel4, entity, 11.0f, 2, (byte) 2);
                            ...
                            if (entity instanceof LivingEntity) {
                                ...
                                ItemStack _setstack3 = new ItemStack(AnnoyingVillagersbychentuModItems.PUTONGHEIYAOSHISHIFANGSHI.get());
                            ...
                            if (entity instanceof LivingEntity) {
                                ...
                                ItemStack _setstack4 = new ItemStack(AnnoyingVillagersbychentuModItems.PUTONGHEIYAOSHIZHU.get());
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.5
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
    ...
    public class C04401 {
        ...
        public class C04411 {
            ...
            private void run() {
                Entity _ent = C04401.this.val$entity;
                if (!_ent.level.isClientSide() && _ent.getServer() != null) {
            ...
            public class C04421 {
                ...
                public class C04431 {
                    ...
                    /* JADX WARN: Type inference failed for: r0v8, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$1$1$1$1] */
                    private void run() {
                        Entity _ent = C04401.this.val$entity;
                        if (!_ent.level.isClientSide() && _ent.getServer() != null) {
                        ...
                        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.1.1.1.1
                            private int ticks = 0;
                            private float waitTicks;
                            private LevelAccessor world;
                            ...
                            /* JADX WARN: Type inference failed for: r0v9, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$1$1$1$1$1] */
                            private void run() {
                                Entity _ent2 = C04401.this.val$entity;
                                ...
                                new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DiJiherobrineDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.1.1.1.1.1
                                    private int ticks = 0;
                                    private float waitTicks;
                                    private LevelAccessor world;
                                    ...
                                    private void run() {
                                        Entity _ent3 = C04401.this.val$entity;
