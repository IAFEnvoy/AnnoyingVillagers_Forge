...
public class Villagerhead4DangYouJianDianJiKongQiShiShiTiDeWeiZhiProcedure {
    public static void execute(Entity entity) {
        ...
        if (entity instanceof Player _player) {
            _player.getInventory().armor.set(3, new ItemStack(AnnoyingVillagersbychentuModItems.VILLAGERHEAD_4.get()));
            _player.getInventory().setChanged();
        } else if (entity instanceof LivingEntity _living) {
            _living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(AnnoyingVillagersbychentuModItems.VILLAGERHEAD_4.get()));
        }
        ...
        if (itemStack.getItem() == AnnoyingVillagersbychentuModItems.VILLAGERHEAD_4.get() && (entity instanceof LivingEntity)) {
