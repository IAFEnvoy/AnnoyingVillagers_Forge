...
public class LanCunQiDangShiTiBeiShaSiShiProcedure {
    /* JADX WARN: Type inference failed for: r0v1, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.LanCunQiDangShiTiBeiShaSiShiProcedure$1] */
    /* JADX WARN: Type inference failed for: r0v14, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.LanCunQiDangShiTiBeiShaSiShiProcedure$2] */
    public static void execute(LevelAccessor world, final double x, final double y, final double z, final Entity entity) {
        if (entity == null) {
            return;
        }
        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.LanCunQiDangShiTiBeiShaSiShiProcedure.1
            private int ticks = 0;
            ...
            private void run() {
                ...
                if (level3 instanceof Level) {
                    ...
                    if (!_level3.isClientSide()) {
                        ItemEntity entityToSpawn3 = new ItemEntity(_level3, x, y + 1.0d, z, new ItemStack(Items.APPLE));
                ...
                if (level4 instanceof Level) {
                    ...
                    if (!_level4.isClientSide()) {
                        ItemEntity entityToSpawn4 = new ItemEntity(_level4, x, y + 1.0d, z, new ItemStack(Items.FISHING_ROD));
                ...
                if (level7 instanceof Level) {
                    ...
                    if (!_level7.isClientSide()) {
                        ItemEntity entityToSpawn7 = new ItemEntity(_level7, x, y + 1.0d, z, new ItemStack(Items.ENCHANTED_GOLDEN_APPLE));
                ...
                if (level8 instanceof Level) {
                    ...
                    if (!_level8.isClientSide()) {
                        ItemEntity entityToSpawn8 = new ItemEntity(_level8, x, y + 1.0d, z, new ItemStack(Blocks.OAK_PLANKS));
                ...
                if (level9 instanceof Level) {
                    ...
                    if (!_level9.isClientSide()) {
                        ItemEntity entityToSpawn9 = new ItemEntity(_level9, x, y + 1.0d, z, new ItemStack(Blocks.OAK_PLANKS));
                ...
                if (level10 instanceof Level) {
                    ...
                    if (!_level10.isClientSide()) {
                        ItemEntity entityToSpawn10 = new ItemEntity(_level10, x, y + 1.0d, z, new ItemStack(Items.IRON_PICKAXE));
                ...
                if (level24 instanceof Level) {
                    ...
                    if (!_level24.isClientSide()) {
                        ItemEntity entityToSpawn24 = new ItemEntity(_level24, x, y + 1.0d, z, new ItemStack(Items.GOLD_INGOT));
                ...
                if (level27 instanceof Level) {
                    ...
                    if (!_level27.isClientSide()) {
                        ItemEntity entityToSpawn27 = new ItemEntity(_level27, x, y + 1.0d, z, new ItemStack(Items.DIAMOND));
        ...
        if (Math.random() <= 0.4d && !world.isClientSide() && world.getServer() != null) {
            world.getServer().getPlayerList().broadcastMessage(new TextComponent("<村民蓝骑兵> 这是协议的一部分......"), ChatType.SYSTEM, Util.NIL_UUID);
        }
        if (Math.random() <= 0.1d) {
            ...
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.LanCunQiDangShiTiBeiShaSiShiProcedure.2
                private int ticks = 0;
                private float waitTicks;
                private LevelAccessor world;
