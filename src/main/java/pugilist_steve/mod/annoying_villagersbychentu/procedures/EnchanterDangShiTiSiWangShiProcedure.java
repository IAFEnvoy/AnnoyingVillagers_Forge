...
public class EnchanterDangShiTiSiWangShiProcedure {
    /* JADX WARN: Type inference failed for: r0v1, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.EnchanterDangShiTiSiWangShiProcedure$1] */
    public static void execute(LevelAccessor world, final double x, final double y, final double z, Entity entity) {
        if (entity == null) {
            return;
        }
        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.EnchanterDangShiTiSiWangShiProcedure.1
            private int ticks = 0;
            ...
            private void run() {
                ...
                if (level instanceof Level) {
                    ...
                    if (!_level.isClientSide()) {
                        ItemEntity entityToSpawn = new ItemEntity(_level, x, y + 0.0d, z, new ItemStack(Items.DIAMOND_CHESTPLATE));
                ...
                if (level2 instanceof Level) {
                    ...
                    if (!_level2.isClientSide()) {
                        ItemEntity entityToSpawn2 = new ItemEntity(_level2, x, y + 0.0d, z, new ItemStack(Items.DIAMOND_CHESTPLATE));
                ...
                if (level3 instanceof Level) {
                    ...
                    if (!_level3.isClientSide()) {
                        ItemEntity entityToSpawn3 = new ItemEntity(_level3, x, y + 0.0d, z, new ItemStack(Items.DIAMOND_LEGGINGS));
                ...
                if (level4 instanceof Level) {
                    ...
                    if (!_level4.isClientSide()) {
                        ItemEntity entityToSpawn4 = new ItemEntity(_level4, x, y + 0.0d, z, new ItemStack(Items.DIAMOND_BOOTS));
                ...
                if (level5 instanceof Level) {
                    ...
                    if (!_level5.isClientSide()) {
                        ItemEntity entityToSpawn5 = new ItemEntity(_level5, x, y + 0.0d, z, new ItemStack(AnnoyingVillagersbychentuModItems.LU_BAO_SHI_CHAN.get()));
                ...
                if (level6 instanceof Level) {
                    ...
                    if (!_level6.isClientSide()) {
                        ItemEntity entityToSpawn6 = new ItemEntity(_level6, x, y + 0.0d, z, new ItemStack(AnnoyingVillagersbychentuModItems.ZZSDP.get()));
                ...
                if (level7 instanceof Level) {
                    ...
                    if (!_level7.isClientSide()) {
                        ItemEntity entityToSpawn7 = new ItemEntity(_level7, x, y + 0.0d, z, new ItemStack(Items.ENDER_PEARL));
                ...
                if (level8 instanceof Level) {
                    ...
                    if (!_level8.isClientSide()) {
                        ItemEntity entityToSpawn8 = new ItemEntity(_level8, x, y + 0.0d, z, new ItemStack(Items.GOLDEN_APPLE));
                ...
                if (level9 instanceof Level) {
                    ...
                    if (!_level9.isClientSide()) {
                        ItemEntity entityToSpawn9 = new ItemEntity(_level9, x, y + 0.0d, z, new ItemStack(Blocks.DIRT));
                ...
                if (level10 instanceof Level) {
                    ...
                    if (!_level10.isClientSide()) {
                        ItemEntity entityToSpawn10 = new ItemEntity(_level10, x, y + 0.0d, z, new ItemStack(Blocks.DIRT));
                ...
                if (level11 instanceof Level) {
                    ...
                    if (!_level11.isClientSide()) {
                        ItemEntity entityToSpawn11 = new ItemEntity(_level11, x, y + 0.0d, z, new ItemStack(Blocks.DIRT));
                ...
                if (level12 instanceof Level) {
                    ...
                    if (!_level12.isClientSide()) {
                        ItemEntity entityToSpawn12 = new ItemEntity(_level12, x, y + 0.0d, z, new ItemStack(Blocks.DIRT));
                ...
                if (level13 instanceof Level) {
                    ...
                    if (!_level13.isClientSide()) {
                        ItemEntity entityToSpawn13 = new ItemEntity(_level13, x, y + 0.0d, z, new ItemStack(Blocks.DIRT));
                ...
                if (level14 instanceof Level) {
                    ...
                    if (!_level14.isClientSide()) {
                        ItemEntity entityToSpawn14 = new ItemEntity(_level14, x, y + 0.0d, z, new ItemStack(Blocks.DIRT));
                ...
                if (level15 instanceof Level) {
                    ...
                    if (!_level15.isClientSide()) {
                        ItemEntity entityToSpawn15 = new ItemEntity(_level15, x, y + 0.0d, z, new ItemStack(Blocks.DIRT));
                ...
                if (level16 instanceof Level) {
                    ...
                    if (!_level16.isClientSide()) {
                        ItemEntity entityToSpawn16 = new ItemEntity(_level16, x, y + 0.0d, z, new ItemStack(Items.DIAMOND_SHOVEL));
                ...
                if (level17 instanceof Level) {
                    ...
                    if (!_level17.isClientSide()) {
                        ItemEntity entityToSpawn17 = new ItemEntity(_level17, x, y + 0.0d, z, new ItemStack(Items.GOLD_INGOT));
                ...
                if (level18 instanceof Level) {
                    ...
                    if (!_level18.isClientSide()) {
                        ItemEntity entityToSpawn18 = new ItemEntity(_level18, x, y + 0.0d, z, new ItemStack(Items.GOLD_INGOT));
                ...
                if (level19 instanceof Level) {
                    ...
                    if (!_level19.isClientSide()) {
                        ItemEntity entityToSpawn19 = new ItemEntity(_level19, x, y + 0.0d, z, new ItemStack(Items.GOLD_INGOT));
                ...
                if (level20 instanceof Level) {
                    ...
                    if (!_level20.isClientSide()) {
                        ItemEntity entityToSpawn20 = new ItemEntity(_level20, x, y + 0.0d, z, new ItemStack(Items.DIAMOND));
                ...
                if (level21 instanceof Level) {
                    ...
                    if (!_level21.isClientSide()) {
                        ItemEntity entityToSpawn21 = new ItemEntity(_level21, x, y + 0.0d, z, new ItemStack(Items.DIAMOND));
                ...
                if (level22 instanceof Level) {
                    ...
                    if (!_level22.isClientSide()) {
                        ItemEntity entityToSpawn22 = new ItemEntity(_level22, x, y + 0.0d, z, new ItemStack(Items.DIAMOND));
                ...
                if (level23 instanceof Level) {
                    ...
                    if (!_level23.isClientSide()) {
                        ItemEntity entityToSpawn23 = new ItemEntity(_level23, x, y + 0.0d, z, new ItemStack(Items.EMERALD));
                ...
                if (level24 instanceof Level) {
                    ...
                    if (!_level24.isClientSide()) {
                        ItemEntity entityToSpawn24 = new ItemEntity(_level24, x, y + 0.0d, z, new ItemStack(Items.EMERALD));
                ...
                if (level25 instanceof Level) {
                    ...
                    if (!_level25.isClientSide()) {
                        ItemEntity entityToSpawn25 = new ItemEntity(_level25, x, y + 0.0d, z, new ItemStack(Items.EMERALD));
                ...
                if (level26 instanceof Level) {
                    ...
                    if (!_level26.isClientSide()) {
                        ItemEntity entityToSpawn26 = new ItemEntity(_level26, x, y + 0.0d, z, new ItemStack(Items.EMERALD));
                ...
                if (level27 instanceof Level) {
                    ...
                    if (!_level27.isClientSide()) {
                        ItemEntity entityToSpawn27 = new ItemEntity(_level27, x, y + 0.0d, z, new ItemStack(Items.EMERALD));
                ...
                if (level28 instanceof Level) {
                    ...
                    if (!_level28.isClientSide()) {
                        ItemEntity entityToSpawn28 = new ItemEntity(_level28, x, y + 0.0d, z, new ItemStack(Items.EMERALD));
                ...
                if (level29 instanceof Level) {
                    ...
                    if (!_level29.isClientSide()) {
                        ItemEntity entityToSpawn29 = new ItemEntity(_level29, x, y + 0.0d, z, new ItemStack(Items.IRON_INGOT));
                ...
                if (level30 instanceof Level) {
                    ...
                    if (!_level30.isClientSide()) {
                        ItemEntity entityToSpawn30 = new ItemEntity(_level30, x, y + 0.0d, z, new ItemStack(Items.IRON_INGOT));
                ...
                if (level31 instanceof Level) {
                    ...
                    if (!_level31.isClientSide()) {
                        ItemEntity entityToSpawn31 = new ItemEntity(_level31, x, y + 0.0d, z, new ItemStack(Items.IRON_INGOT));
                ...
                if (level32 instanceof Level) {
                    ...
                    if (!_level32.isClientSide()) {
                        ItemEntity entityToSpawn32 = new ItemEntity(_level32, x, y + 0.0d, z, new ItemStack(Items.IRON_INGOT));
        ...
        if (world.players().size() >= 5) {
            if (!entity.level.isClientSide() && entity.getServer() != null) {
                entity.getServer().getCommands().performCommand(entity.createCommandSourceStack().withSuppressedOutput().withPermission(4), "tellraw @a {\"text\":\"Enchanter left the game\",\"color\":\"yellow\"}");
            }
        } else if (!entity.level.isClientSide() && entity.getServer() != null) {
            entity.getServer().getCommands().performCommand(entity.createCommandSourceStack().withSuppressedOutput().withPermission(4), "tellraw @a {\"text\":\"Enchanter退出了游戏\",\"color\":\"yellow\"}");
        }
    }
}
