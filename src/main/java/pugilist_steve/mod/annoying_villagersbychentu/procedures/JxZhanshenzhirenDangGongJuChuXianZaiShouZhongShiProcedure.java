...
public class JxZhanshenzhirenDangGongJuChuXianZaiShouZhongShiProcedure {
    public static void execute(Entity entity) {
        ...
        if (entity instanceof LivingEntity _entity2) {
            if (!_entity2.level.isClientSide()) {
                _entity2.addEffect(new MobEffectInstance(MobEffects.JUMP, 1, 2));
            }
        }
        if (entity instanceof LivingEntity _entity3) {
            if (!_entity3.level.isClientSide()) {
                _entity3.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 60, 1, false, false));
            }
        }
    }
}
