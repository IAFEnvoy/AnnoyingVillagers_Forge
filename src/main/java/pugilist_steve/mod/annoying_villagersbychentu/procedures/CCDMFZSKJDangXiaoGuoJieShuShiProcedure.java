...
public class CCDMFZSKJDangXiaoGuoJieShuShiProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        if (EnchantmentHelper.getItemEnchantmentLevel(enchantment, itemStack) != 0) {
            ...
            if (itemStack8.getItem() == AnnoyingVillagersbychentuModItems.CHUNCUIDEMOFAZUANSHI_HELMET.get()) {
        ...
        if (EnchantmentHelper.getItemEnchantmentLevel(enchantment2, itemStack2) != 0) {
            ...
            if (itemStack7.getItem() == AnnoyingVillagersbychentuModItems.CHUNCUIDEMOFAZUANSHI_CHESTPLATE.get()) {
        ...
        if (EnchantmentHelper.getItemEnchantmentLevel(enchantment3, itemStack3) != 0) {
            ...
            if (itemStack6.getItem() == AnnoyingVillagersbychentuModItems.CHUNCUIDEMOFAZUANSHI_LEGGINGS.get()) {
        ...
        if (EnchantmentHelper.getItemEnchantmentLevel(enchantment4, itemStack4) != 0) {
            ...
            if (itemStack5.getItem() == AnnoyingVillagersbychentuModItems.CHUNCUIDEMOFAZUANSHI_BOOTS.get()) {
