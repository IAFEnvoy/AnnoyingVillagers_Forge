...
public class CunMinZhenChaBingDangShiTiSiWangShiProcedure {
    /* JADX WARN: Type inference failed for: r0v1, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChaBingDangShiTiSiWangShiProcedure$1] */
    /* JADX WARN: Type inference failed for: r0v10, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChaBingDangShiTiSiWangShiProcedure$2] */
    public static void execute(LevelAccessor world, final double x, final double y, final double z, final Entity entity) {
        if (entity == null) {
            return;
        }
        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChaBingDangShiTiSiWangShiProcedure.1
            private int ticks = 0;
            ...
            private void run() {
                ...
                if (level5 instanceof Level) {
                    ...
                    if (!_level5.isClientSide()) {
                        ItemEntity entityToSpawn5 = new ItemEntity(_level5, x, y + 1.0d, z, new ItemStack(Items.ENDER_PEARL));
                ...
                if (level8 instanceof Level) {
                    ...
                    if (!_level8.isClientSide()) {
                        ItemEntity entityToSpawn8 = new ItemEntity(_level8, x, y + 1.0d, z, new ItemStack(AnnoyingVillagersbychentuModItems.CUNZHENTOUKUI.get()));
                ...
                if (level9 instanceof Level) {
                    ...
                    if (!_level9.isClientSide()) {
                        ItemEntity entityToSpawn9 = new ItemEntity(_level9, x, y + 1.0d, z, new ItemStack(Items.IRON_SWORD));
                ...
                if (level14 instanceof Level) {
                    ...
                    if (!_level14.isClientSide()) {
                        ItemEntity entityToSpawn14 = new ItemEntity(_level14, x, y + 1.0d, z, new ItemStack(Items.GOLD_INGOT));
                ...
                if (level15 instanceof Level) {
                    ...
                    if (!_level15.isClientSide()) {
                        ItemEntity entityToSpawn15 = new ItemEntity(_level15, x, y + 1.0d, z, new ItemStack(Items.GOLD_INGOT));
        ...
        if (Math.random() <= 0.11d) {
            ...
            if (!world.isClientSide() && world.getServer() != null) {
                world.getServer().getPlayerList().broadcastMessage(new TextComponent("<村民侦查兵> 请求支援！"), ChatType.SYSTEM, Util.NIL_UUID);
            }
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChaBingDangShiTiSiWangShiProcedure.2
                private int ticks = 0;
                private float waitTicks;
                private LevelAccessor world;
