...
public class DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure {
    /* JADX WARN: Type inference failed for: r0v1, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1] */
    public static void execute(LevelAccessor world, final double x, final double y, final double z, final Entity entity) {
        if (entity == null) {
            return;
        }
        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1
            private int ticks = 0;
            ...
            /* JADX WARN: Type inference failed for: r0v23, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$2] */
            /* JADX WARN: Type inference failed for: r0v24, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$3] */
            /* JADX WARN: Type inference failed for: r0v49, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$1] */
            private void run() {
                if (Math.random() <= 0.05d) {
                    ...
                    if (!projectileLevel.isClientSide()) {
                        Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.1
                            public Projectile getArrow(Level level3, Entity shooter, float damage, int knockback) {
                        ...
                        }.getArrow(projectileLevel, entity, 6.0f, 5);
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.2
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
                        ...
                        /* JADX WARN: Type inference failed for: r0v33, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$2$2] */
                        /* JADX WARN: Type inference failed for: r0v65, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$2$1] */
                        private void run() {
                            Entity _shootFrom2 = entity;
                            Level projectileLevel2 = _shootFrom2.level;
                            if (!projectileLevel2.isClientSide()) {
                                Projectile _entityToSpawn2 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.2.1
                                    public Projectile getArrow(Level level3, Entity shooter, float damage, int knockback) {
                                        AbstractArrow entityToSpawn = new YinshenEntity(AnnoyingVillagersbychentuModEntities.YINSHEN.get(), level3);
                                        entityToSpawn.setOwner(shooter);
                                        entityToSpawn.setBaseDamage(damage);
                                ...
                                }.getArrow(projectileLevel2, entity, 6.0f, 4);
                            ...
                            if (!projectileLevel3.isClientSide()) {
                                Projectile _entityToSpawn3 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.2.2
                                    public Projectile getArrow(Level level3, Entity shooter, float damage, int knockback) {
                                        AbstractArrow entityToSpawn = new YinshenEntity(AnnoyingVillagersbychentuModEntities.YINSHEN.get(), level3);
                                        entityToSpawn.setOwner(shooter);
                                        entityToSpawn.setBaseDamage(damage);
                                ...
                                }.getArrow(projectileLevel3, entity, 8.0f, 4);
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.3
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
