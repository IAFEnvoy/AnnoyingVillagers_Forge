...
public class CunMinZhenChabingsmartskillProcedure {
    /* JADX WARN: Type inference failed for: r0v69, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure$4] */
    /* JADX WARN: Type inference failed for: r0v96, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure$5] */
    /* JADX WARN: Type inference failed for: r1v63, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure$1] */
    /* JADX WARN: Type inference failed for: r1v70, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure$2] */
    /* JADX WARN: Type inference failed for: r2v13, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure$6] */
    /* JADX WARN: Type inference failed for: r2v3, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure$3] */
    public static void execute(LevelAccessor world, final double x, final double y, final double z, final Entity entity) {
        ...
        if (!world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 2.0d, 2.0d, 2.0d), e -> {
            ...
            if (!world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 2.0d, 2.0d, 2.0d), e2 -> {
                return true;
            }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure.1
                ...
                world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 2.0d, 2.0d, 2.0d), e3 -> {
                    return true;
                }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure.2
                    Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble(_entcnd -> {
                            return _entcnd.distanceToSqr(_x, _y, _z);
                        });
        ...
        if (livingEntity == world.getEntitiesOfClass(Mob.class, AABB.ofSize(new Vec3(x, y, z), 4.0d, 4.0d, 4.0d), e4 -> {
            return true;
        }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure.3
            Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                return Comparator.comparingDouble(_entcnd -> {
                    return _entcnd.distanceToSqr(_x, _y, _z);
                });
            ...
            if (entity2 == livingEntity3) {
                ...
                if (itemStack.getItem() instanceof BowItem) {
                    ...
                    if (Math.random() <= 0.05d) {
                        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure.4
                            private int ticks = 0;
                            ...
                            /* JADX WARN: Type inference failed for: r0v17, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure$4$1] */
                            private void run() {
                                Entity _shootFrom = entity;
                                Level projectileLevel = _shootFrom.level;
                                if (!projectileLevel.isClientSide()) {
                                    Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure.4.1
                    ...
                    if (itemStack2.getItem() instanceof CrossbowItem) {
                        ...
                        if (Math.random() <= 0.05d) {
                            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure.5
                                private int ticks = 0;
                                private float waitTicks;
                                private LevelAccessor world;
                                ...
                                /* JADX WARN: Type inference failed for: r0v17, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure$5$1] */
                                private void run() {
                                    Entity _shootFrom = entity;
                                    Level projectileLevel = _shootFrom.level;
                                    if (!projectileLevel.isClientSide()) {
                                        Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure.5.1
                                            public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
                                                Arrow arrow = new Arrow(EntityType.ARROW, level);
                                                arrow.setOwner(shooter);
                                                arrow.setBaseDamage(damage);
        ...
        List<Entity> _entfound2 = world.getEntitiesOfClass(Entity.class, new AABB(_center2, _center2).inflate(2.5d), e6 -> {
            return true;
        ...
        for (Entity entity3 : _entfound2) {
            ...
            if (entity3 == livingEntity2) {
                ...
                if (entity.getControllingPassenger() == world.getEntitiesOfClass(Sheep.class, AABB.ofSize(new Vec3(x, y, z), 3.0d, 3.0d, 3.0d), e7 -> {
                    return true;
                }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChabingsmartskillProcedure.6
                    Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
