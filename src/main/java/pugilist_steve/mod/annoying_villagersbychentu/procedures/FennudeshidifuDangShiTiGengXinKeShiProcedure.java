...
public class FennudeshidifuDangShiTiGengXinKeShiProcedure {
    /* JADX WARN: Type inference failed for: r0v345, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure$1] */
    /* JADX WARN: Type inference failed for: r0v76, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure$8] */
    /* JADX WARN: Type inference failed for: r0v77, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure$9] */
    /* JADX WARN: Type inference failed for: r1v76, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure$2] */
    /* JADX WARN: Type inference failed for: r1v83, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure$3] */
    /* JADX WARN: Type inference failed for: r2v18, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure$5] */
    /* JADX WARN: Type inference failed for: r2v22, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure$6] */
    /* JADX WARN: Type inference failed for: r2v26, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure$7] */
    /* JADX WARN: Type inference failed for: r2v44, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure$4] */
    public static void execute(LevelAccessor world, final double x, final double y, final double z, final Entity entity) {
        ...
        if (entity.isAlive()) {
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure.1
                private int ticks = 0;
        ...
        if (!world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 2.0d, 2.0d, 2.0d), e2 -> {
            ...
            if (!world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 2.0d, 2.0d, 2.0d), e3 -> {
                return true;
            }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure.2
                ...
                world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 2.0d, 2.0d, 2.0d), e4 -> {
                    return true;
                }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure.3
                    Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble(_entcnd -> {
                            return _entcnd.distanceToSqr(_x, _y, _z);
                        });
        ...
        if (!world.getEntitiesOfClass(Mob.class, AABB.ofSize(new Vec3(x, y, z), 4.0d, 4.0d, 4.0d), e10 -> {
            ...
            return true;
        }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure.4
            Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                return Comparator.comparingDouble(_entcnd -> {
                    return _entcnd.distanceToSqr(_x, _y, _z);
                });
        ...
        if (livingEntity == world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 4.0d, 4.0d, 4.0d), e12 -> {
            return true;
        }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure.5
            Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                return Comparator.comparingDouble(_entcnd -> {
                    return _entcnd.distanceToSqr(_x, _y, _z);
                });
            }
        }.compareDistOf(x, y, z)).findFirst().orElse(null) && Math.random() <= 0.2d && (entity instanceof LivingEntity _entity9)) {
        ...
        if (livingEntity2 == world.getEntitiesOfClass(Mob.class, AABB.ofSize(new Vec3(x, y, z), 4.0d, 4.0d, 4.0d), e13 -> {
            return true;
        }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure.6
            Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                return Comparator.comparingDouble(_entcnd -> {
                    return _entcnd.distanceToSqr(_x, _y, _z);
                });
            }
        }.compareDistOf(x, y, z)).findFirst().orElse(null) && Math.random() <= 0.26d && (entity instanceof LivingEntity _entity10)) {
            if (!_entity10.level.isClientSide()) {
                _entity10.addEffect(new MobEffectInstance(AnnoyingVillagersbychentuModMobEffects.GEDANG.get(), 10, 4, false, false));
            }
        }
        ...
        if (livingEntity3 == world.getEntitiesOfClass(Monster.class, AABB.ofSize(new Vec3(x, y, z), 4.0d, 4.0d, 4.0d), e14 -> {
            return true;
        }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure.7
            Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                return Comparator.comparingDouble(_entcnd -> {
                    return _entcnd.distanceToSqr(_x, _y, _z);
                });
            }
        }.compareDistOf(x, y, z)).findFirst().orElse(null) && Math.random() <= 0.26d && (entity instanceof LivingEntity _entity11)) {
            if (!_entity11.level.isClientSide()) {
                _entity11.addEffect(new MobEffectInstance(AnnoyingVillagersbychentuModMobEffects.GEDANG.get(), 10, 4, false, false));
            }
        }
        Vec3 _center = new Vec3(x, y, z);
        List<Entity> _entfound = world.getEntitiesOfClass(Entity.class, new AABB(_center, _center).inflate(30.0d), e15 -> {
            return true;
        ...
        for (Entity entity2 : _entfound) {
            ...
            if (entity2 == livingEntity4) {
                ...
                if (livingEntity9 instanceof LivingEntity) {
                    LivingEntity _livEnt = livingEntity9;
                ...
                if (itemStack.getItem() instanceof BowItem) {
                    ...
                    if (Math.random() <= 0.3d) {
                        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure.8
                            private int ticks = 0;
                            private float waitTicks;
                            private LevelAccessor world;
                            ...
                            /* JADX WARN: Type inference failed for: r0v17, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure$8$1] */
                            private void run() {
                                Entity _shootFrom = entity;
                                Level projectileLevel = _shootFrom.level;
                                if (!projectileLevel.isClientSide()) {
                                    Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure.8.1
                                ...
                                if (level instanceof Level) {
                                    ...
                                    if (!_level3.isClientSide()) {
                                        _level3.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.arrow.shoot")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                                    } else {
                                        _level3.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.arrow.shoot")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                                    }
                                }
                                MinecraftForge.EVENT_BUS.unregister(this);
                            }
                        }.start(world, Mth.nextInt(new Random(), 1, 10));
                        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.FennudeshidifuDangShiTiGengXinKeShiProcedure.9
                            private int ticks = 0;
                            private float waitTicks;
                            private LevelAccessor world;
