...
public class C0277x2038be8d {
    /* JADX WARN: Type inference failed for: r0v1, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1] */
    public static void execute(LevelAccessor world, final double x, final double y, final double z, final Entity entity) {
        if (entity == null) {
            return;
        }
        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1
            private int ticks = 0;
            ...
            /* JADX WARN: Type inference failed for: r0v29, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$3] */
            /* JADX WARN: Type inference failed for: r0v30, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$4] */
            /* JADX WARN: Type inference failed for: r0v55, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$2] */
            /* JADX WARN: Type inference failed for: r0v61, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$1] */
            private void run() {
                if (Math.random() <= 0.05d) {
                    ...
                    if (!projectileLevel.isClientSide()) {
                        Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.1
                    ...
                    if (!projectileLevel2.isClientSide()) {
                        Projectile _entityToSpawn2 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.2
                            public Projectile getArrow(Level level3, Entity shooter, float damage, int knockback, byte piercing) {
                                AbstractArrow entityToSpawn = new YinshenEntity(AnnoyingVillagersbychentuModEntities.YINSHEN.get(), level3);
                                entityToSpawn.setOwner(shooter);
                                entityToSpawn.setBaseDamage(damage);
                        ...
                        }.getArrow(projectileLevel2, entity, 15.0f, 5, (byte) 2);
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.3
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
                        ...
                        /* JADX WARN: Type inference failed for: r0v37, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$3$2] */
                        /* JADX WARN: Type inference failed for: r0v69, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure$1$3$1] */
                        private void run() {
                            ...
                            if (!projectileLevel3.isClientSide()) {
                                Projectile _entityToSpawn3 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.3.1
                                ...
                                }.getArrow(projectileLevel3, entity, 16.0f, 4, (byte) 3);
                            ...
                            if (!projectileLevel4.isClientSide()) {
                                Projectile _entityToSpawn4 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.3.2
                                    public Projectile getArrow(Level level4, Entity shooter, float damage, int knockback, byte piercing) {
                                        AbstractArrow entityToSpawn = new YinshenEntity(AnnoyingVillagersbychentuModEntities.YINSHEN.get(), level4);
                                        entityToSpawn.setOwner(shooter);
                                        entityToSpawn.setBaseDamage(damage);
                                ...
                                }.getArrow(projectileLevel4, entity, 16.0f, 5, (byte) 2);
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.AnyinghimfenshenDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.1.4
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
