...
public class Null1ShiTiChuShiShengChengShiProcedure {
    /* JADX WARN: Type inference failed for: r0v1, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.Null1ShiTiChuShiShengChengShiProcedure$1] */
    public static void execute(LevelAccessor world, final Entity entity) {
        if (entity == null) {
            return;
        }
        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.Null1ShiTiChuShiShengChengShiProcedure.1
            private int ticks = 0;
            ...
            private void run() {
                ...
                if (entity instanceof LivingEntity) {
                    ...
                    _player5.setItemInHand(InteractionHand.OFF_HAND, _setstack);
