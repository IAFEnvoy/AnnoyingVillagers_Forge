...
public class JiemodeshuDangWuPinZaiShouShangMeiKeFaShengProcedure {
    public static void execute(Entity entity) {
        ...
        if (entity instanceof LivingEntity _entity2) {
            if (!_entity2.level.isClientSide()) {
                _entity2.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 1, 10, false, false));
            }
        }
        if (entity instanceof LivingEntity _entity3) {
            if (!_entity3.level.isClientSide()) {
                _entity3.addEffect(new MobEffectInstance(MobEffects.WEAKNESS, 1, 10, false, false));
            }
        }
    }
}
