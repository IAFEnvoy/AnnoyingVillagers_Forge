...
public class ShiTi303DangShiTiGengXinKeShiProcedure {
    /* JADX WARN: Type inference failed for: r1v2, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.ShiTi303DangShiTiGengXinKeShiProcedure$1] */
    /* JADX WARN: Type inference failed for: r1v8, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.ShiTi303DangShiTiGengXinKeShiProcedure$2] */
    public static void execute(LevelAccessor world, double x, double y, double z) {
        if (!world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 1.0d, 1.0d, 1.0d), e -> {
            ...
            if (!world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 1.0d, 1.0d, 1.0d), e2 -> {
                return true;
            }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.ShiTi303DangShiTiGengXinKeShiProcedure.1
                ...
                world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 1.0d, 1.0d, 1.0d), e3 -> {
                    return true;
                }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.ShiTi303DangShiTiGengXinKeShiProcedure.2
                    Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble(_entcnd -> {
                            return _entcnd.distanceToSqr(_x, _y, _z);
                        });
