...
public class LanCunQiDangYouJiShiTiShiProcedure {
    /* JADX WARN: Type inference failed for: r1v10, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.LanCunQiDangYouJiShiTiShiProcedure$2] */
    /* JADX WARN: Type inference failed for: r1v14, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.LanCunQiDangYouJiShiTiShiProcedure$3] */
    /* JADX WARN: Type inference failed for: r1v4, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.LanCunQiDangYouJiShiTiShiProcedure$1] */
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        if (f <= 7.0f) {
            ...
            if (itemStack.getItem() == Blocks.OBSIDIAN.asItem()) {
                ...
                if (world instanceof Level _level2) {
                    if (!_level2.isClientSide()) {
                        _level2.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.villager.work_leatherworker")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                    } else {
                        _level2.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.villager.work_leatherworker")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                    }
                }
                ...
                if (livingEntity6 instanceof Player _player2) {
                    if (!_player2.level.isClientSide()) {
                        _player2.displayClientMessage(new TextComponent("已俘"), false);
                        return;
                    }
                    return;
                }
            ...
            LivingEntity livingEntity7 = world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 5.0d, 5.0d, 5.0d), e -> {
                return true;
            }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.LanCunQiDangYouJiShiTiShiProcedure.1
            ...
            if (itemStack2.getItem() == Blocks.OBSIDIAN.asItem()) {
                ...
                if (world instanceof Level _level4) {
                    if (!_level4.isClientSide()) {
                        _level4.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.villager.work_leatherworker")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                    } else {
                        _level4.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.villager.work_leatherworker")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                    }
                }
                if (!entity.level.isClientSide() && entity.getServer() != null) {
                    entity.getServer().getCommands().performCommand(entity.createCommandSourceStack().withSuppressedOutput().withPermission(4), "/summon annoying_villagersbychentu:lan_cun_qi_fu_lu ^ ^ ^ {VillagerData:{level:4,profession:\"minecraft:weaponsmith\"}}");
                ...
                Player player = world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 5.0d, 5.0d, 5.0d), e2 -> {
                    return true;
                }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.LanCunQiDangYouJiShiTiShiProcedure.2
                    Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble(_entcnd -> {
                            return _entcnd.distanceToSqr(_x, _y, _z);
                        });
                ...
                Player player2 = world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 5.0d, 5.0d, 5.0d), e3 -> {
                    return true;
                }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.LanCunQiDangYouJiShiTiShiProcedure.3
                    Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble(_entcnd -> {
                            return _entcnd.distanceToSqr(_x, _y, _z);
                        });
                ...
                if (player2 instanceof Player) {
                    ...
                    if (!_player4.level.isClientSide()) {
                        _player4.displayClientMessage(new TextComponent("已俘"), false);
                    }
                }
            }
        }
