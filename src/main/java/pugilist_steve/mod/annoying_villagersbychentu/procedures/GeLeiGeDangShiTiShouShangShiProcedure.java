...
public class GeLeiGeDangShiTiShouShangShiProcedure {
    /* JADX WARN: Type inference failed for: r0v11, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure$3] */
    /* JADX WARN: Type inference failed for: r0v12, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure$2] */
    /* JADX WARN: Type inference failed for: r0v27, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure$1] */
    public static void execute(LevelAccessor world, double x, double y, double z, final Entity entity) {
        ...
        if (Math.random() <= 0.375d) {
            ...
            for (Entity entity2 : _entfound) {
                ...
                if (entity2 == livingEntity && (entity instanceof LivingEntity _entity)) {
        ...
        if (Math.random() <= 0.33d && (entity instanceof LivingEntity _entity2)) {
        ...
        if (Math.random() <= 0.09d) {
            ...
            if (!projectileLevel.isClientSide()) {
                Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure.1
        ...
        if (Math.random() <= 0.05d) {
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure.2
                private int ticks = 0;
                ...
                /* JADX WARN: Type inference failed for: r0v17, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure$2$1] */
                private void run() {
                    ...
                    if (!projectileLevel2.isClientSide()) {
                        Projectile _entityToSpawn2 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure.2.1
                            public Projectile getProjectile(Level level, Entity shooter) {
                                ThrownEnderpearl thrownEnderpearl = new ThrownEnderpearl(EntityType.ENDER_PEARL, level);
                                thrownEnderpearl.setOwner(shooter);
                                return thrownEnderpearl;
        ...
        if (Math.random() <= 0.09d) {
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure.3
                private int ticks = 0;
                private float waitTicks;
                private LevelAccessor world;
                ...
                /* JADX WARN: Type inference failed for: r0v24, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure$3$2] */
                /* JADX WARN: Type inference failed for: r0v30, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure$3$3] */
                /* JADX WARN: Type inference failed for: r0v54, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure$3$1] */
                private void run() {
                    ItemStack itemStack;
                    ...
                    Level projectileLevel2 = _shootFrom.level;
                    if (!projectileLevel2.isClientSide()) {
                        Projectile _entityToSpawn2 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure.3.1
                            public Projectile getProjectile(Level level, Entity shooter) {
                                ThrownEnderpearl thrownEnderpearl = new ThrownEnderpearl(EntityType.ENDER_PEARL, level);
                                thrownEnderpearl.setOwner(shooter);
                                return thrownEnderpearl;
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure.3.2
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
                        ...
                        private void run() {
                            if (entity instanceof LivingEntity) {
                                ...
                                if (!_entity5.level.isClientSide()) {
                                    _entity5.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 60, 2, false, false));
                                }
                            }
                            MinecraftForge.EVENT_BUS.unregister(this);
                        }
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure.3.3
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
                        ...
                        /* JADX WARN: Type inference failed for: r0v135, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure$3$3$1] */
                        private void run() {
                            ...
                            if (!projectileLevel3.isClientSide()) {
                                Projectile _entityToSpawn3 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.GeLeiGeDangShiTiShouShangShiProcedure.3.3.1
                                    public Projectile getProjectile(Level level, Entity shooter) {
                                        ThrownEnderpearl thrownEnderpearl = new ThrownEnderpearl(EntityType.ENDER_PEARL, level);
                                        thrownEnderpearl.setOwner(shooter);
                                        return thrownEnderpearl;
                            ...
                            if (Math.random() <= 0.1d) {
                                if (entity instanceof LivingEntity) {
                                    ...
                                    ItemStack _setstack2 = new ItemStack(Items.STONE_SWORD);
                                ...
                                if (entity instanceof LivingEntity) {
                                    ...
                                    itemStack6 = _livEnt6.getMainHandItem();
                                } else {
