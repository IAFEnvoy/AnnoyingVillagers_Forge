...
public class CunMinZhenChaBingDangYouJiShiTiShiProcedure {
    /* JADX WARN: Type inference failed for: r1v10, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChaBingDangYouJiShiTiShiProcedure$2] */
    /* JADX WARN: Type inference failed for: r1v14, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChaBingDangYouJiShiTiShiProcedure$3] */
    /* JADX WARN: Type inference failed for: r1v4, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChaBingDangYouJiShiTiShiProcedure$1] */
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        if (f <= 7.0f) {
            ...
            LivingEntity livingEntity7 = world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 5.0d, 5.0d, 5.0d), e -> {
                return true;
            }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChaBingDangYouJiShiTiShiProcedure.1
            ...
            if (itemStack2.getItem() == Blocks.OBSIDIAN.asItem()) {
                ...
                Player player = world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 5.0d, 5.0d, 5.0d), e2 -> {
                    return true;
                }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChaBingDangYouJiShiTiShiProcedure.2
                    Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble(_entcnd -> {
                            return _entcnd.distanceToSqr(_x, _y, _z);
                        });
                ...
                Player player2 = world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 5.0d, 5.0d, 5.0d), e3 -> {
                    return true;
                }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CunMinZhenChaBingDangYouJiShiTiShiProcedure.3
                    Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble(_entcnd -> {
                            return _entcnd.distanceToSqr(_x, _y, _z);
                        });
