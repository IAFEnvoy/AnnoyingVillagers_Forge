...
public class ZhanShenZhiRenDangShiTiBeiGongJuJiZhongShiProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        if (_ist.hurt(260, new Random(), null)) {
            _ist.shrink(1);
        ...
        if (_ist2.hurt(260, new Random(), null)) {
            _ist2.shrink(1);
        ...
        if (_ist3.hurt(260, new Random(), null)) {
            _ist3.shrink(1);
        ...
        if (_ist4.hurt(260, new Random(), null)) {
            _ist4.shrink(1);
        ...
        if (Math.random() < 0.3d) {
            ...
            if (_ist5.hurt(700, new Random(), null)) {
                _ist5.shrink(1);
        ...
        if (Math.random() < 0.3d) {
            ...
            if (_ist6.hurt(700, new Random(), null)) {
                _ist6.shrink(1);
                _ist6.setDamageValue(0);
            }
            if (world instanceof Level _level2) {
                if (!_level2.isClientSide()) {
                    _level2.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.glass.break")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                } else {
                    _level2.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.glass.break")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                }
            }
        }
        if (Math.random() < 0.3d) {
            ...
            if (_ist7.hurt(700, new Random(), null)) {
                _ist7.shrink(1);
                _ist7.setDamageValue(0);
            }
            if (world instanceof Level _level3) {
                if (!_level3.isClientSide()) {
                    _level3.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.glass.break")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                } else {
                    _level3.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.glass.break")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                }
            }
        }
        if (Math.random() < 0.3d) {
            ...
            if (_ist8.hurt(700, new Random(), null)) {
                _ist8.shrink(1);
                _ist8.setDamageValue(0);
            }
            if (world instanceof Level _level4) {
                if (!_level4.isClientSide()) {
                    _level4.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.glass.break")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                } else {
                    _level4.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.glass.break")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                }
            }
        }
        if (Math.random() < 0.1d) {
            ...
            if (_ist9.hurt(900, new Random(), null)) {
                _ist9.shrink(1);
            ...
            if (_ist10.hurt(900, new Random(), null)) {
                _ist10.shrink(1);
            ...
            if (_ist11.hurt(900, new Random(), null)) {
                _ist11.shrink(1);
            ...
            if (_ist12.hurt(900, new Random(), null)) {
                _ist12.shrink(1);
                _ist12.setDamageValue(0);
            }
            if (world instanceof Level _level5) {
                if (!_level5.isClientSide()) {
                    _level5.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.item.break")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                } else {
                    _level5.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.item.break")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                }
            }
            if (world instanceof Level _level6) {
                if (!_level6.isClientSide()) {
                    _level6.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.glass.break")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                } else {
                    _level6.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.glass.break")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                }
            }
        }
    }
