...
public class HongCunQiDangShiTiBeiShaSiShiProcedure {
    /* JADX WARN: Type inference failed for: r0v1, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.HongCunQiDangShiTiBeiShaSiShiProcedure$1] */
    /* JADX WARN: Type inference failed for: r0v17, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.HongCunQiDangShiTiBeiShaSiShiProcedure$2] */
    public static void execute(LevelAccessor world, final double x, final double y, final double z, final Entity entity) {
        if (entity == null) {
            return;
        }
        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.HongCunQiDangShiTiBeiShaSiShiProcedure.1
            private int ticks = 0;
            ...
            private void run() {
                ...
                if (level instanceof Level) {
                    ...
                    if (!_level.isClientSide()) {
                        ItemEntity entityToSpawn = new ItemEntity(_level, x, y + 1.0d, z, new ItemStack(AnnoyingVillagersbychentuModItems.GOU_ZHUANG_ZUAN_SHI_JIAN.get()));
                ...
                if (level2 instanceof Level) {
                    ...
                    if (!_level2.isClientSide()) {
                        ItemEntity entityToSpawn2 = new ItemEntity(_level2, x, y + 1.0d, z, new ItemStack(Items.DIAMOND));
                ...
                if (level3 instanceof Level) {
                    ...
                    if (!_level3.isClientSide()) {
                        ItemEntity entityToSpawn3 = new ItemEntity(_level3, x, y + 1.0d, z, new ItemStack(Items.DIAMOND));
                ...
                if (level4 instanceof Level) {
                    ...
                    if (!_level4.isClientSide()) {
                        ItemEntity entityToSpawn4 = new ItemEntity(_level4, x, y + 1.0d, z, new ItemStack(Items.DIAMOND));
                ...
                if (level5 instanceof Level) {
                    ...
                    if (!_level5.isClientSide()) {
                        ItemEntity entityToSpawn5 = new ItemEntity(_level5, x, y + 1.0d, z, new ItemStack(Items.DIAMOND));
                ...
                if (level7 instanceof Level) {
                    ...
                    if (!_level7.isClientSide()) {
                        ItemEntity entityToSpawn7 = new ItemEntity(_level7, x, y + 1.0d, z, new ItemStack(Items.BREAD));
                ...
                if (level8 instanceof Level) {
                    ...
                    if (!_level8.isClientSide()) {
                        ItemEntity entityToSpawn8 = new ItemEntity(_level8, x, y + 1.0d, z, new ItemStack(Items.ENCHANTED_GOLDEN_APPLE));
                ...
                if (level9 instanceof Level) {
                    ...
                    if (!_level9.isClientSide()) {
                        ItemEntity entityToSpawn9 = new ItemEntity(_level9, x, y + 1.0d, z, new ItemStack(Items.ENCHANTED_GOLDEN_APPLE));
                ...
                if (level10 instanceof Level) {
                    ...
                    if (!_level10.isClientSide()) {
                        ItemEntity entityToSpawn10 = new ItemEntity(_level10, x, y + 1.0d, z, new ItemStack(Items.ENCHANTED_GOLDEN_APPLE));
                ...
                if (level11 instanceof Level) {
                    ...
                    if (!_level11.isClientSide()) {
                        ItemEntity entityToSpawn11 = new ItemEntity(_level11, x, y + 1.0d, z, new ItemStack(Items.ENCHANTED_GOLDEN_APPLE));
                ...
                if (level12 instanceof Level) {
                    ...
                    if (!_level12.isClientSide()) {
                        ItemEntity entityToSpawn12 = new ItemEntity(_level12, x, y + 1.0d, z, new ItemStack(Items.WHEAT));
                ...
                if (level13 instanceof Level) {
                    ...
                    if (!_level13.isClientSide()) {
                        ItemEntity entityToSpawn13 = new ItemEntity(_level13, x, y + 1.0d, z, new ItemStack(Items.WHEAT));
                ...
                if (level14 instanceof Level) {
                    ...
                    if (!_level14.isClientSide()) {
                        ItemEntity entityToSpawn14 = new ItemEntity(_level14, x, y + 1.0d, z, new ItemStack(AnnoyingVillagersbychentuModItems.CCHUNDUZUANSHI.get()));
                ...
                if (level21 instanceof Level) {
                    ...
                    if (!_level21.isClientSide()) {
                        ItemEntity entityToSpawn21 = new ItemEntity(_level21, x, y + 1.0d, z, new ItemStack(Items.ENDER_PEARL));
                ...
                if (level26 instanceof Level) {
                    ...
                    if (!_level26.isClientSide()) {
                        ItemEntity entityToSpawn26 = new ItemEntity(_level26, x, y + 1.0d, z, new ItemStack(Items.ARROW));
                ...
                if (level29 instanceof Level) {
                    ...
                    if (!_level29.isClientSide()) {
                        ItemEntity entityToSpawn29 = new ItemEntity(_level29, x, y + 1.0d, z, new ItemStack(Items.IRON_PICKAXE));
                ...
                if (level30 instanceof Level) {
                    ...
                    if (!_level30.isClientSide()) {
                        ItemEntity entityToSpawn30 = new ItemEntity(_level30, x, y + 1.0d, z, new ItemStack(Items.APPLE));
                ...
                if (level31 instanceof Level) {
                    ...
                    if (!_level31.isClientSide()) {
                        ItemEntity entityToSpawn31 = new ItemEntity(_level31, x, y + 1.0d, z, new ItemStack(Items.APPLE));
                ...
                if (level32 instanceof Level) {
                    ...
                    if (!_level32.isClientSide()) {
                        ItemEntity entityToSpawn32 = new ItemEntity(_level32, x, y + 1.0d, z, new ItemStack(Items.GOLD_INGOT));
                ...
                if (level33 instanceof Level) {
                    ...
                    if (!_level33.isClientSide()) {
                        ItemEntity entityToSpawn33 = new ItemEntity(_level33, x, y + 1.0d, z, new ItemStack(Items.GOLD_INGOT));
                ...
                if (level34 instanceof Level) {
                    ...
                    if (!_level34.isClientSide()) {
                        ItemEntity entityToSpawn34 = new ItemEntity(_level34, x, y + 1.0d, z, new ItemStack(Items.GOLD_INGOT));
                ...
                if (level37 instanceof Level) {
                    ...
                    if (!_level37.isClientSide()) {
                        ItemEntity entityToSpawn37 = new ItemEntity(_level37, x, y + 1.0d, z, new ItemStack(Items.FIREWORK_ROCKET));
                ...
                if (level39 instanceof Level) {
                    ...
                    if (!_level39.isClientSide()) {
                        ItemEntity entityToSpawn39 = new ItemEntity(_level39, x, y + 1.0d, z, new ItemStack(Items.POISONOUS_POTATO));
                ...
                if (level40 instanceof Level) {
                    ...
                    if (!_level40.isClientSide()) {
                        ItemEntity entityToSpawn40 = new ItemEntity(_level40, x, y + 1.0d, z, new ItemStack(Items.EMERALD));
                ...
                if (level41 instanceof Level) {
                    ...
                    if (!_level41.isClientSide()) {
                        ItemEntity entityToSpawn41 = new ItemEntity(_level41, x, y + 1.0d, z, new ItemStack(Items.EMERALD));
                ...
                if (level42 instanceof Level) {
                    ...
                    if (!_level42.isClientSide()) {
                        ItemEntity entityToSpawn42 = new ItemEntity(_level42, x, y + 1.0d, z, new ItemStack(Items.EMERALD));
        ...
        if (Math.random() <= 0.11d) {
            ...
            if (!world.isClientSide() && world.getServer() != null) {
                world.getServer().getPlayerList().broadcastMessage(new TextComponent("<村民红骑兵> 我们遇到了技术熟练的玩家，请求支援！"), ChatType.SYSTEM, Util.NIL_UUID);
            }
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.HongCunQiDangShiTiBeiShaSiShiProcedure.2
                private int ticks = 0;
                private float waitTicks;
                private LevelAccessor world;
            ...
            world.getServer().getPlayerList().broadcastMessage(new TextComponent("<村民红骑兵> 誓死效力于村民国王......"), ChatType.SYSTEM, Util.NIL_UUID);
        }
    }
}
