...
public class SteveDangShiTiGengXinKeShiProcedure {
    /* JADX WARN: Type inference failed for: r0v294, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure$1] */
    /* JADX WARN: Type inference failed for: r0v45, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure$6] */
    /* JADX WARN: Type inference failed for: r0v69, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure$4] */
    /* JADX WARN: Type inference failed for: r0v96, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure$5] */
    /* JADX WARN: Type inference failed for: r1v44, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure$2] */
    /* JADX WARN: Type inference failed for: r1v51, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure$3] */
    public static void execute(LevelAccessor world, final double x, final double y, final double z, final Entity entity) {
        ...
        if (entity.isAlive()) {
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure.1
                private int ticks = 0;
        ...
        if (!world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 2.0d, 2.0d, 2.0d), e2 -> {
            ...
            if (!world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 2.0d, 2.0d, 2.0d), e3 -> {
                return true;
            }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure.2
                ...
                world.getEntitiesOfClass(ItemEntity.class, AABB.ofSize(new Vec3(x, y, z), 2.0d, 2.0d, 2.0d), e4 -> {
                    return true;
                }).stream().sorted(new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure.3
                    Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble(_entcnd -> {
                            return _entcnd.distanceToSqr(_x, _y, _z);
                        });
        ...
        if (!world.getEntitiesOfClass(LuCunQiEntity.class, AABB.ofSize(new Vec3(x, y, z), 4.0d, 4.0d, 4.0d), e8 -> {
            return true;
        ...
        if (!world.getEntitiesOfClass(Monster.class, AABB.ofSize(new Vec3(x, y, z), 4.0d, 4.0d, 4.0d), e9 -> {
            return true;
        }).isEmpty() && Math.random() <= 0.02d && (entity instanceof LivingEntity _entity7)) {
        ...
        List<Entity> _entfound = world.getEntitiesOfClass(Entity.class, new AABB(_center, _center).inflate(30.0d), e10 -> {
            return true;
        ...
        for (Entity entity2 : _entfound) {
            ...
            if (entity2 == livingEntity) {
                ...
                if (livingEntity10 instanceof LivingEntity) {
                    LivingEntity _livEnt = livingEntity10;
                ...
                if (itemStack2.getItem() instanceof BowItem) {
                    ...
                    double getX = livingEntity3.getX();
                    if (entity instanceof Mob _mobEnt4) {
                        livingEntity4 = _mobEnt4.getTarget();
                    } else {
                        livingEntity4 = null;
                    }
                    double getY = livingEntity4.getY();
                    if (entity instanceof Mob _mobEnt5) {
                        livingEntity5 = _mobEnt5.getTarget();
                    } else {
                        livingEntity5 = null;
                    }
                    entity.lookAt(anchor, new Vec3(getX, getY, livingEntity5.getZ()));
                    if (Math.random() <= 0.3d) {
                        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure.4
                            private int ticks = 0;
                            private float waitTicks;
                            private LevelAccessor world;
                            ...
                            /* JADX WARN: Type inference failed for: r0v17, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure$4$1] */
                            private void run() {
                                Entity _shootFrom = entity;
                                Level projectileLevel = _shootFrom.level;
                                if (!projectileLevel.isClientSide()) {
                                    Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure.4.1
                    ...
                    LivingEntity livingEntity11 = livingEntity6;
                    if (livingEntity11 instanceof LivingEntity) {
                        LivingEntity _livEnt2 = livingEntity11;
                        itemStack3 = _livEnt2.getMainHandItem();
                    } else {
                        itemStack3 = ItemStack.EMPTY;
                    }
                    if (itemStack3.getItem() instanceof CrossbowItem) {
                        if (entity instanceof LivingEntity) {
                        ...
                        double getX2 = livingEntity7.getX();
                        if (entity instanceof Mob _mobEnt8) {
                            livingEntity8 = _mobEnt8.getTarget();
                        } else {
                            livingEntity8 = null;
                        }
                        double getY2 = livingEntity8.getY();
                        if (entity instanceof Mob _mobEnt9) {
                            livingEntity9 = _mobEnt9.getTarget();
                        } else {
                            livingEntity9 = null;
                        }
                        entity.lookAt(anchor2, new Vec3(getX2, getY2, livingEntity9.getZ()));
                        if (Math.random() <= 0.3d) {
                            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure.5
                                private int ticks = 0;
                                private float waitTicks;
                                private LevelAccessor world;
                                ...
                                /* JADX WARN: Type inference failed for: r0v17, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure$5$1] */
                                private void run() {
                                    Entity _shootFrom = entity;
                                    Level projectileLevel = _shootFrom.level;
                                    if (!projectileLevel.isClientSide()) {
                                        Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure.5.1
                                            public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
                                                Arrow arrow = new Arrow(EntityType.ARROW, level);
                                                arrow.setOwner(shooter);
                                                arrow.setBaseDamage(damage);
        ...
        if (itemStack.getItem() instanceof BowItem) {
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.SteveDangShiTiGengXinKeShiProcedure.6
                private int ticks = 0;
                private float waitTicks;
                private LevelAccessor world;
