...
public class CczdzDangShiTiShouShangShiProcedure {
    /* JADX WARN: Type inference failed for: r0v111, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$2] */
    /* JADX WARN: Type inference failed for: r0v112, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$1] */
    /* JADX WARN: Type inference failed for: r0v19, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$3] */
    /* JADX WARN: Type inference failed for: r0v26, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$4] */
    /* JADX WARN: Type inference failed for: r0v45, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$7] */
    /* JADX WARN: Type inference failed for: r0v46, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$6] */
    /* JADX WARN: Type inference failed for: r0v61, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$5] */
            ...
            if (entity2 == livingEntity) {
                if (Math.random() <= 0.09d) {
                    ...
                    if (!projectileLevel.isClientSide()) {
                        Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.1
                    ...
                    if (Math.random() <= 0.4d) {
                        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.2
                            private int ticks = 0;
                            ...
                            /* JADX WARN: Type inference failed for: r0v7, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$2$1] */
                            private void run() {
                                Entity _shootFrom = entity;
                                Level projectileLevel2 = _shootFrom.level;
                                if (!projectileLevel2.isClientSide()) {
                                    Projectile _entityToSpawn2 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.2.1
                                        public Projectile getProjectile(Level level, Entity shooter) {
                                            ThrownEnderpearl thrownEnderpearl = new ThrownEnderpearl(EntityType.ENDER_PEARL, level);
                                            thrownEnderpearl.setOwner(shooter);
                                            return thrownEnderpearl;
                ...
                new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.3
                    private int ticks = 0;
                    private float waitTicks;
                    private LevelAccessor world;
                ...
                new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.4
                    private int ticks = 0;
                    private float waitTicks;
                    private LevelAccessor world;
                ...
                if (Math.random() <= 0.29d && (entity instanceof LivingEntity _entity2)) {
                ...
                if (Math.random() <= 0.09d) {
                    ...
                    if (!projectileLevel2.isClientSide()) {
                        Projectile _entityToSpawn2 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.5
                            public Projectile getProjectile(Level level, Entity shooter) {
                                ThrownEnderpearl thrownEnderpearl = new ThrownEnderpearl(EntityType.ENDER_PEARL, level);
                                thrownEnderpearl.setOwner(shooter);
                                return thrownEnderpearl;
                ...
                if (Math.random() <= 0.05d) {
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.6
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
                        ...
                        /* JADX WARN: Type inference failed for: r0v17, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$6$1] */
                        private void run() {
                            ...
                            if (!projectileLevel3.isClientSide()) {
                                Projectile _entityToSpawn3 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.6.1
                                    public Projectile getProjectile(Level level, Entity shooter) {
                                        ThrownEnderpearl thrownEnderpearl = new ThrownEnderpearl(EntityType.ENDER_PEARL, level);
                                        thrownEnderpearl.setOwner(shooter);
                                        return thrownEnderpearl;
                ...
                if (Math.random() <= 0.09d) {
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.7
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
                        ...
                        /* JADX WARN: Type inference failed for: r0v29, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$7$2] */
                        /* JADX WARN: Type inference failed for: r0v53, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$7$1] */
                        private void run() {
                            ...
                            Level projectileLevel3 = _shootFrom.level;
                            if (!projectileLevel3.isClientSide()) {
                                Projectile _entityToSpawn3 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.7.1
                                    public Projectile getProjectile(Level level, Entity shooter) {
                                        ThrownEnderpearl thrownEnderpearl = new ThrownEnderpearl(EntityType.ENDER_PEARL, level);
                                        thrownEnderpearl.setOwner(shooter);
                                        return thrownEnderpearl;
                            ...
                            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.7.2
                                private int ticks = 0;
                                private float waitTicks;
                                private LevelAccessor world;
                                ...
                                /* JADX WARN: Type inference failed for: r0v80, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure$7$2$1] */
                                private void run() {
                                    ...
                                    if (!projectileLevel4.isClientSide()) {
                                        Projectile _entityToSpawn4 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.CczdzDangShiTiShouShangShiProcedure.7.2.1
                                            public Projectile getProjectile(Level level, Entity shooter) {
                                                ThrownEnderpearl thrownEnderpearl = new ThrownEnderpearl(EntityType.ENDER_PEARL, level);
                                                thrownEnderpearl.setOwner(shooter);
                                                return thrownEnderpearl;
                ...
                if (f <= 7.0f) {
                    entity.setCustomName(new TextComponent("村侦队长[可俘虏]"));
                }
            }
        }
    }
