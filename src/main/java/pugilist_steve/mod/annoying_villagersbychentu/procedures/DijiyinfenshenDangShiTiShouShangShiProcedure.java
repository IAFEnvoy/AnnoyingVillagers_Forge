...
public class DijiyinfenshenDangShiTiShouShangShiProcedure {
    /* JADX WARN: Type inference failed for: r0v2, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$1] */
    /* JADX WARN: Type inference failed for: r0v30, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$3] */
    /* JADX WARN: Type inference failed for: r0v31, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$4] */
    /* JADX WARN: Type inference failed for: r0v5, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$5] */
    /* JADX WARN: Type inference failed for: r0v54, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$2] */
    public static void execute(LevelAccessor world, final double x, final double y, final double z, final Entity entity) {
        if (entity == null) {
            return;
        }
        entity.setSprinting(true);
        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.1
            private int ticks = 0;
        ...
        if (Math.random() <= 0.52d) {
            ...
            if (!projectileLevel.isClientSide()) {
                Projectile _entityToSpawn = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.2
                ...
                }.getArrow(projectileLevel, entity, 14.0f, 5, (byte) 3);
            ...
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.3
                private int ticks = 0;
                private float waitTicks;
                private LevelAccessor world;
                ...
                /* JADX WARN: Type inference failed for: r0v48, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$3$2] */
                /* JADX WARN: Type inference failed for: r0v54, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$3$1] */
                private void run() {
                    Entity _shootFrom = entity;
                    Level projectileLevel2 = _shootFrom.level;
                    if (!projectileLevel2.isClientSide()) {
                        Projectile _entityToSpawn2 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.3.1
                            public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
                                AbstractArrow entityToSpawn = new YinshenEntity(AnnoyingVillagersbychentuModEntities.YINSHEN.get(), level);
                                entityToSpawn.setOwner(shooter);
                                entityToSpawn.setBaseDamage(damage);
                        ...
                        }.getArrow(projectileLevel2, entity, 14.0f, 4, (byte) 2);
                    ...
                    if (!projectileLevel3.isClientSide()) {
                        Projectile _entityToSpawn3 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.3.2
                            public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
                                AbstractArrow entityToSpawn = new YinshenEntity(AnnoyingVillagersbychentuModEntities.YINSHEN.get(), level);
                                entityToSpawn.setOwner(shooter);
                                entityToSpawn.setBaseDamage(damage);
                        ...
                        }.getArrow(projectileLevel3, entity, 14.0f, 4, (byte) 4);
            ...
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.4
                private int ticks = 0;
                private float waitTicks;
                private LevelAccessor world;
        ...
        new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.5
            private int ticks = 0;
            private float waitTicks;
            private LevelAccessor world;
            ...
            /* JADX WARN: Type inference failed for: r0v29, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$5$3] */
            /* JADX WARN: Type inference failed for: r0v30, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$5$4] */
            /* JADX WARN: Type inference failed for: r0v55, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$5$2] */
            /* JADX WARN: Type inference failed for: r0v61, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$5$1] */
            private void run() {
                if (Math.random() <= 0.34d) {
                    ...
                    Level projectileLevel2 = _shootFrom.level;
                    if (!projectileLevel2.isClientSide()) {
                        Projectile _entityToSpawn2 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.5.1
                        ...
                        }.getArrow(projectileLevel2, entity, 14.0f, 5, (byte) 4);
                        _entityToSpawn2.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1d, _shootFrom.getZ());
                        _entityToSpawn2.shoot(_shootFrom.getLookAngle().x, _shootFrom.getLookAngle().y, _shootFrom.getLookAngle().z, 1.0f, 0.0f);
                        projectileLevel2.addFreshEntity(_entityToSpawn2);
                    }
                    ...
                    Level projectileLevel3 = _shootFrom2.level;
                    if (!projectileLevel3.isClientSide()) {
                        Projectile _entityToSpawn3 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.5.2
                            public Projectile getArrow(Level level3, Entity shooter, float damage, int knockback, byte piercing) {
                                AbstractArrow entityToSpawn = new YinshenEntity(AnnoyingVillagersbychentuModEntities.YINSHEN.get(), level3);
                                entityToSpawn.setOwner(shooter);
                                entityToSpawn.setBaseDamage(damage);
                        ...
                        }.getArrow(projectileLevel3, entity, 14.0f, 5, (byte) 4);
                        _entityToSpawn3.setPos(_shootFrom2.getX(), _shootFrom2.getEyeY() - 0.1d, _shootFrom2.getZ());
                        _entityToSpawn3.shoot(_shootFrom2.getLookAngle().x, _shootFrom2.getLookAngle().y, _shootFrom2.getLookAngle().z, 1.0f, 0.0f);
                        projectileLevel3.addFreshEntity(_entityToSpawn3);
                    }
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.5.3
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
                        ...
                        /* JADX WARN: Type inference failed for: r0v37, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$5$3$2] */
                        /* JADX WARN: Type inference failed for: r0v75, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure$5$3$1] */
                        private void run() {
                            Entity _shootFrom3 = entity;
                            Level projectileLevel4 = _shootFrom3.level;
                            if (!projectileLevel4.isClientSide()) {
                                Projectile _entityToSpawn4 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.5.3.1
                                    public Projectile getArrow(Level level3, Entity shooter, float damage, int knockback, byte piercing) {
                                        AbstractArrow entityToSpawn = new YinshenEntity(AnnoyingVillagersbychentuModEntities.YINSHEN.get(), level3);
                                        entityToSpawn.setOwner(shooter);
                                        entityToSpawn.setBaseDamage(damage);
                                ...
                                }.getArrow(projectileLevel4, entity, 10.0f, 4, (byte) 3);
                                _entityToSpawn4.setPos(_shootFrom3.getX(), _shootFrom3.getEyeY() - 0.1d, _shootFrom3.getZ());
                                _entityToSpawn4.shoot(_shootFrom3.getLookAngle().x, _shootFrom3.getLookAngle().y, _shootFrom3.getLookAngle().z, 1.0f, 0.0f);
                                projectileLevel4.addFreshEntity(_entityToSpawn4);
                            }
                            if (entity instanceof LivingEntity) {
                                Player player5 = (LivingEntity) entity;
                                ItemStack _setstack5 = new ItemStack(AnnoyingVillagersbychentuModItems.ANYINGHEIYAOSHIZHUSHIFANG.get());
                            ...
                            if (entity instanceof LivingEntity) {
                                ...
                                ItemStack _setstack6 = new ItemStack(AnnoyingVillagersbychentuModItems.ANYINGHEIYAOSHICHANGZHU.get());
                            ...
                            Level projectileLevel5 = _shootFrom4.level;
                            if (!projectileLevel5.isClientSide()) {
                                Projectile _entityToSpawn5 = new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.5.3.2
                                ...
                                }.getArrow(projectileLevel5, entity, 13.0f, 4, (byte) 4);
                                _entityToSpawn5.setPos(_shootFrom4.getX(), _shootFrom4.getEyeY() - 0.1d, _shootFrom4.getZ());
                                _entityToSpawn5.shoot(_shootFrom4.getLookAngle().x, _shootFrom4.getLookAngle().y, _shootFrom4.getLookAngle().z, 1.0f, 0.0f);
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.DijiyinfenshenDangShiTiShouShangShiProcedure.5.4
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
                        ...
                        private void run() {
                            ...
                            if (entity instanceof LivingEntity) {
                                Player player5 = (LivingEntity) entity;
                                ItemStack _setstack5 = new ItemStack(Blocks.AIR);
                                _setstack5.setCount(1);
                                player5.setItemInHand(InteractionHand.MAIN_HAND, _setstack5);
                                if (player5 instanceof Player) {
                                    Player _player5 = player5;
        ...
        if (Math.random() > 0.28d || !(entity instanceof LivingEntity _entity)) {
            return;
        }
