...
public class KuijiaxiaoguoDangYaoShuiXiaoGuoKaiShiYingYongShiProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        if (itemStack.getItem() == Blocks.AIR.asItem()) {
            if (world instanceof Level _level) {
                if (!_level.isClientSide()) {
                    _level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.armor.equip_diamond")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                } else {
                    _level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.armor.equip_diamond")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                }
            }
            if (entity instanceof Player _player) {
                _player.getInventory().armor.set(3, new ItemStack(AnnoyingVillagersbychentuModItems.CCHUNZUANTAO_HELMET.get()));
        ...
        new C09431(entity, x, y, z).start(world, 2);
    ...
    public class C09431 {
        ...
        C09431(Entity entity, double d, double d2, double d3) {
        ...
        /* JADX WARN: Type inference failed for: r0v6, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.KuijiaxiaoguoDangYaoShuiXiaoGuoKaiShiYingYongShiProcedure$1$1] */
        private void run() {
            ItemStack itemStack;
            ItemStack itemStack2;
            ItemStack itemStack3;
            ...
            if (itemStack.getItem() == Blocks.AIR.asItem()) {
                ...
                if (player instanceof Player) {
                    ...
                    _player.getInventory().armor.set(2, new ItemStack(AnnoyingVillagersbychentuModItems.CCHUNZUANTAO_CHESTPLATE.get()));
                    _player.getInventory().setChanged();
                } else if (player instanceof LivingEntity) {
                    LivingEntity _living = player;
                    _living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(AnnoyingVillagersbychentuModItems.CCHUNZUANTAO_CHESTPLATE.get()));
                }
                if (this.val$entity instanceof LivingEntity) {
            ...
            new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.KuijiaxiaoguoDangYaoShuiXiaoGuoKaiShiYingYongShiProcedure.1.1
                private int ticks = 0;
                private float waitTicks;
                private LevelAccessor world;
                ...
                /* JADX WARN: Type inference failed for: r0v7, types: [pugilist_steve.mod.annoying_villagersbychentu.procedures.KuijiaxiaoguoDangYaoShuiXiaoGuoKaiShiYingYongShiProcedure$1$1$1] */
                private void run() {
                    ItemStack itemStack5;
                    ItemStack itemStack6;
                    ItemStack itemStack7;
                    ItemStack itemStack8;
                    if (C09431.this.val$entity instanceof LivingEntity) {
                        LivingEntity _entGetArmor5 = C09431.this.val$entity;
                    ...
                    if (itemStack5.getItem() == Blocks.AIR.asItem()) {
                        ...
                        if (level2 instanceof Level) {
                            ...
                            if (!_level2.isClientSide()) {
                                _level2.playSound(null, new BlockPos(C09431.this.val$x, C09431.this.val$y, C09431.this.val$z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.armor.equip_diamond")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                            } else {
                                _level2.playLocalSound(C09431.this.val$x, C09431.this.val$y, C09431.this.val$z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.armor.equip_diamond")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                            }
                        }
                        Player player2 = C09431.this.val$entity;
                        if (player2 instanceof Player) {
                            Player _player2 = player2;
                            _player2.getInventory().armor.set(1, new ItemStack(AnnoyingVillagersbychentuModItems.CCHUNZUANTAO_LEGGINGS.get()));
                            _player2.getInventory().setChanged();
                        } else if (player2 instanceof LivingEntity) {
                            LivingEntity _living2 = player2;
                            _living2.setItemSlot(EquipmentSlot.LEGS, new ItemStack(AnnoyingVillagersbychentuModItems.CCHUNZUANTAO_LEGGINGS.get()));
                        }
                        if (C09431.this.val$entity instanceof LivingEntity) {
                            LivingEntity _entGetArmor6 = C09431.this.val$entity;
                        ...
                        if (C09431.this.val$entity instanceof LivingEntity) {
                            LivingEntity _entGetArmor7 = C09431.this.val$entity;
                        ...
                        if (C09431.this.val$entity instanceof LivingEntity) {
                            LivingEntity _entGetArmor8 = C09431.this.val$entity;
                    ...
                    new Object() { // from class: pugilist_steve.mod.annoying_villagersbychentu.procedures.KuijiaxiaoguoDangYaoShuiXiaoGuoKaiShiYingYongShiProcedure.1.1.1
                        private int ticks = 0;
                        private float waitTicks;
                        private LevelAccessor world;
                        ...
                        private void run() {
                            ...
                            if (C09431.this.val$entity instanceof LivingEntity) {
                                LivingEntity _entGetArmor9 = C09431.this.val$entity;
                            ...
                            if (itemStack9.getItem() == Blocks.AIR.asItem()) {
                                Player player3 = C09431.this.val$entity;
                                if (player3 instanceof Player) {
                                    Player _player3 = player3;
                                    _player3.getInventory().armor.set(0, new ItemStack(AnnoyingVillagersbychentuModItems.CCHUNZUANTAO_BOOTS.get()));
                                    _player3.getInventory().setChanged();
                                } else if (player3 instanceof LivingEntity) {
                                    LivingEntity _living3 = player3;
                                    _living3.setItemSlot(EquipmentSlot.FEET, new ItemStack(AnnoyingVillagersbychentuModItems.CCHUNZUANTAO_BOOTS.get()));
                                }
                                Level level3 = this.world;
                                if (level3 instanceof Level) {
                                    Level _level3 = level3;
                                    if (!_level3.isClientSide()) {
                                        _level3.playSound(null, new BlockPos(C09431.this.val$x, C09431.this.val$y, C09431.this.val$z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.armor.equip_diamond")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                                    } else {
                                        _level3.playLocalSound(C09431.this.val$x, C09431.this.val$y, C09431.this.val$z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.armor.equip_diamond")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                                    }
                                }
                                if (C09431.this.val$entity instanceof LivingEntity) {
                                    LivingEntity _entGetArmor10 = C09431.this.val$entity;
                                ...
                                if (C09431.this.val$entity instanceof LivingEntity) {
                                    LivingEntity _entGetArmor11 = C09431.this.val$entity;
                                ...
                                if (C09431.this.val$entity instanceof LivingEntity) {
                                    LivingEntity _entGetArmor12 = C09431.this.val$entity;
